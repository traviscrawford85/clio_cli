...
class Matter(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responsible_staff": UserBase.from_dict(obj["responsible_staff"]) if obj.get("responsible_staff") is not None else None,
            ...
            "split_invoice_payers": [SplitInvoicePayerBase.from_dict(_item) for _item in obj["split_invoice_payers"]] if obj.get("split_invoice_payers") is not None else None
        })
        return _obj
