...
class MattersApi:
    ...
    def matter_index(
        ...
        responsible_staff_id: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. Use the keyword `null` to match those without a Matter. The list will be filtered to include only the Matter records with the matching property.")] = None,
        ...
        :param responsible_staff_id: The unique identifier for a single User. Use the keyword `null` to match those without a Matter. The list will be filtered to include only the Matter records with the matching property.
        :type responsible_staff_id: int
    ...
    def _matter_index_serialize(
        ...
        if responsible_staff_id is not None:
            
            _query_params.append(('responsible_staff_id', responsible_staff_id))
