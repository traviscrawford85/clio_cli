...
class BillsApi:
    ...
    def bill_index(
        ...
        currency_id: Annotated[Optional[StrictInt], Field(description="Filter Bill records to those of a specific currency.")] = None,
        ...
        :param currency_id: Filter Bill records to those of a specific currency.
    ...
    def _bill_preview_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bills/{id}/preview',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
