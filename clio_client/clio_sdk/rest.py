...
class RESTClientObject:
    ...
    def request(
        ...
        if hasattr(self, "configuration") and getattr(self.configuration, "access_token", None):
            headers["Authorization"] = f"Bearer {self.configuration.access_token}"
            print("[DEBUG] Injected Authorization header:", headers["Authorization"])
        else:
            print("[DEBUG] No access token found in configuration; headers:", headers)
