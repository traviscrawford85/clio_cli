    ...
    def make_instance(self, include_optional) -> TrustRequestCreateRequest:
        ...
        if include_optional:
            return TrustRequestCreateRequest(
                data = clio_sdk.models.trust_request_create_request_data.TrustRequest_create_request_data(
                    approved = True, 
                    client_id = 56, 
                    currency_id = 56, 
                    ...
                    matter = [
                        clio_sdk.models.trust_request_create_request_data_matter_inner.TrustRequest_create_request_data_matter_inner(
                            id = 56, 
                            trust_amount = 56, 
                            note = '', )
                        ], 
