    ...
    def make_instance(self, include_optional) -> TaskUpdateRequest:
        ...
        if include_optional:
            return TaskUpdateRequest(
                data = clio_sdk.models.task_update_request_data.Task_update_request_data(
                    assignee = clio_sdk.models.task_update_request_data_assignee.Task_update_request_data_assignee(
                        id = 56, 
                        type = 'User', ), 
                    cascading = True, 
                    cascading_offset = 56, 
