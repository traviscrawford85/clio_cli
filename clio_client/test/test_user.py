    ...
    def make_instance(self, include_optional) -> User:
        ...
        if include_optional:
            return User(
                ...
                default_activity_description = clio_sdk.models.activity_description_base.ActivityDescription_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                ...
                account = clio_sdk.models.account_base.Account_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    state = '', 
                ...
                contact = clio_sdk.models.contact_base.Contact_base(
                    ...
                    sales_tax_number = '', 
                    currency = clio_sdk.models.currency.currency(), ),
                job_title = clio_sdk.models.job_title_base.JobTitle_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    initials = '', ),
                groups = [
                    clio_sdk.models.group_base.Group_base(
