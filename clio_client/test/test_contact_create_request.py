    ...
    def make_instance(self, include_optional) -> ContactCreateRequest:
        ...
        if include_optional:
            return ContactCreateRequest(
                data = clio_sdk.models.contact_create_request_data.Contact_create_request_data(
                    addresses = [
                        clio_sdk.models.contact_create_request_data_addresses_inner.Contact_create_request_data_addresses_inner(
                            name = 'Other', 
                            street = '', 
                            city = '', 
                            province = '', 
                    ...
                    custom_field_set_associations = [
                        clio_sdk.models.contact_create_request_data_custom_field_set_associations_inner.Contact_create_request_data_custom_field_set_associations_inner(
                            display_order = 56, 
                    ...
                    email_addresses = [
                        clio_sdk.models.contact_create_request_data_email_addresses_inner.Contact_create_request_data_email_addresses_inner(
                            name = 'Other', 
                            address = '', 
                            default_email = True, )
                        ], 
                    first_name = '', 
                    instant_messengers = [
                        clio_sdk.models.contact_create_request_data_instant_messengers_inner.Contact_create_request_data_instant_messengers_inner(
                            name = 'Other', 
                            address = '', )
                        ], 
                    last_name = '', 
                    ...
                    name = '', 
                    phone_numbers = [
                        clio_sdk.models.contact_create_request_data_phone_numbers_inner.Contact_create_request_data_phone_numbers_inner(
                            name = 'Other', 
                            number = '', 
                            default_number = True, )
                        ], 
                    ...
                    type = 'Person', 
                    web_sites = [
                        clio_sdk.models.contact_create_request_data_web_sites_inner.Contact_create_request_data_web_sites_inner(
                            name = 'Other', 
                            address = '', 
