        ...
        if include_optional:
            return MatterContacts(
                ...
                secondary_address = clio_sdk.models.address_base.Address_base(
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                secondary_web_site = clio_sdk.models.web_site_base.WebSite_base(
                    id = 56, 
                    etag = '', 
                    address = '', 
                    name = 'Work', 
                ...
                custom_field_values = [
                    clio_sdk.models.custom_field_value_base.CustomFieldValue_base(
                        id = '', 
                        etag = '', 
                        field_name = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                relationship = clio_sdk.models.relationship_base.Relationship_base(
                    id = 56, 
                    etag = '', 
                    description = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
