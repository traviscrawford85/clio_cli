    ...
    def make_instance(self, include_optional) -> CommentUpdateRequest:
        ...
        if include_optional:
            return CommentUpdateRequest(
                data = clio_sdk.models.comment_update_request_data.Comment_update_request_data(
                    item = clio_sdk.models.comment_update_request_data_item.Comment_update_request_data_item(
                        id = 56, ), 
                    message = '', )
            )
        else:
