    ...
    def make_instance(self, include_optional) -> TaskTemplateListCopyRequest:
        ...
        if include_optional:
            return TaskTemplateListCopyRequest(
                data = clio_sdk.models.task_template_list_copy_request_data.TaskTemplateList_copy_request_data(
                    description = '', 
                    name = '', 
                    practice_area = clio_sdk.models.task_template_list_copy_request_data_practice_area.TaskTemplateList_copy_request_data_practice_area(
                        id = 56, ), )
            )
        else:
            return TaskTemplateListCopyRequest(
