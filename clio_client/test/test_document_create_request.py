    ...
    def make_instance(self, include_optional) -> DocumentCreateRequest:
        ...
        if include_optional:
            return DocumentCreateRequest(
                data = clio_sdk.models.document_create_request_data.Document_create_request_data(
                    communication_id = 56, 
                    content_type = '', 
                    document_category = clio_sdk.models.document_copy_request_data_document_category.Document_copy_request_data_document_category(
                        id = 56, ), 
                    external_properties = [
                        clio_sdk.models.document_create_request_data_external_properties_inner.Document_create_request_data_external_properties_inner(
                            name = '', 
                            value = '', )
                        ], 
                    filename = 'name', 
                    multiparts = [
                        clio_sdk.models.document_create_request_data_multiparts_inner.Document_create_request_data_multiparts_inner(
                            part_number = 56, 
                            content_length = '', 
                            content_md5 = '', )
                        ], 
                    name = '', 
                    parent = clio_sdk.models.document_copy_request_data_parent.Document_copy_request_data_parent(
                        id = 56, 
                        type = 'Document', ), 
