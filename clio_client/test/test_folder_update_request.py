    ...
    def make_instance(self, include_optional) -> FolderUpdateRequest:
        ...
        if include_optional:
            return FolderUpdateRequest(
                data = clio_sdk.models.folder_update_request_data.Folder_update_request_data(
                    document_category = clio_sdk.models.folder_create_request_data_document_category.Folder_create_request_data_document_category(
                        id = 56, ), 
                    external_properties = [
                        clio_sdk.models.folder_update_request_data_external_properties_inner.Folder_update_request_data_external_properties_inner(
                            id = 56, 
                            name = '', 
                            value = '', 
                            _destroy = True, )
                    ...
                    name = '', 
                    parent = clio_sdk.models.folder_update_request_data_parent.Folder_update_request_data_parent(
                        id = 56, 
                        type = 'Folder', ), 
                    restore = True, )
            )
