    ...
    def make_instance(self, include_optional) -> FolderCreateRequest:
        ...
        if include_optional:
            return FolderCreateRequest(
                data = clio_sdk.models.folder_create_request_data.Folder_create_request_data(
                    document_category = clio_sdk.models.folder_create_request_data_document_category.Folder_create_request_data_document_category(
                        id = 56, ), 
                    external_properties = [
                        clio_sdk.models.folder_create_request_data_external_properties_inner.Folder_create_request_data_external_properties_inner(
                            name = '', 
                            value = '', )
                        ], 
                    name = '', 
                    parent = clio_sdk.models.folder_create_request_data_parent.Folder_create_request_data_parent(
                        id = 56, 
                        type = 'Folder', ), 
                    restore = True, )
            )
