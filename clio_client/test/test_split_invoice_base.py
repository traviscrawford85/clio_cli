...
class TestSplitInvoiceBase(unittest.TestCase):
    """SplitInvoiceBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SplitInvoiceBase:
        """Test SplitInvoiceBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SplitInvoiceBase`
        """
        model = SplitInvoiceBase()
        if include_optional:
