    ...
    def make_instance(self, include_optional) -> DocumentAutomationCreateRequest:
        ...
        if include_optional:
            return DocumentAutomationCreateRequest(
                data = clio_sdk.models.document_automation_create_request_data.DocumentAutomation_create_request_data(
                    document_template = clio_sdk.models.document_automation_create_request_data_document_template.DocumentAutomation_create_request_data_document_template(
                        id = 56, ), 
                    filename = '', 
                    formats = [
                        'pdf'
                        ], 
                    matter = clio_sdk.models.document_automation_create_request_data_matter.DocumentAutomation_create_request_data_matter(
                        id = 56, ), )
            )
        else:
            return DocumentAutomationCreateRequest(
