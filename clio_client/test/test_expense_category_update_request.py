    ...
    def make_instance(self, include_optional) -> ExpenseCategoryUpdateRequest:
        ...
        if include_optional:
            return ExpenseCategoryUpdateRequest(
                data = clio_sdk.models.expense_category_update_request_data.ExpenseCategory_update_request_data(
                    currency = clio_sdk.models.currency.currency(), 
                    entry_type = 'hard_cost', 
                    groups = [
                        clio_sdk.models.expense_category_create_request_data_groups_inner.ExpenseCategory_create_request_data_groups_inner(
                            id = 56, 
                            _deleted = True, )
                        ], 
                    name = '', 
                    rate = 1.337, 
                    utbms_code = clio_sdk.models.expense_category_create_request_data_utbms_code.ExpenseCategory_create_request_data_utbms_code(
                        id = 56, ), )
            )
        else:
            return ExpenseCategoryUpdateRequest(
