    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestData:
        ...
        if include_optional:
            return MatterUpdateRequestData(
                billable = True,
                client = clio_sdk.models.matter_update_request_data_client.Matter_update_request_data_client(
                    id = 56, ),
                client_reference = '',
                close_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                currency = None,
                custom_field_set_associations = [
                    clio_sdk.models.matter_update_request_data_custom_field_set_associations_inner.Matter_update_request_data_custom_field_set_associations_inner(
                        id = 56, 
                        display_order = 56, 
                ...
                custom_field_values = [
                    clio_sdk.models.matter_update_request_data_custom_field_values_inner.Matter_update_request_data_custom_field_values_inner(
                        value = '', 
                ...
                custom_rate = clio_sdk.models.matter_update_request_data_custom_rate.Matter_update_request_data_custom_rate(
                    type = 'FlatRate', 
                    rates = [
                        clio_sdk.models.matter_update_request_data_custom_rate_rates_inner.Matter_update_request_data_custom_rate_rates_inner(
                            user = clio_sdk.models.matter_update_request_data_custom_rate_rates_inner_user.Matter_update_request_data_custom_rate_rates_inner_user(
                                id = 56, ), 
                            award = 1.337, 
                            note = '', 
                ...
                description = '',
                display_number = '',
                evergreen_retainer = clio_sdk.models.matter_update_request_data_evergreen_retainer.Matter_update_request_data_evergreen_retainer(
                ...
                practice_area = clio_sdk.models.matter_create_request_data_practice_area.Matter_create_request_data_practice_area(
                    id = 56, ),
                relationships = [
                    clio_sdk.models.matter_update_request_data_relationships_inner.Matter_update_request_data_relationships_inner(
                        description = '', 
                        contact = clio_sdk.models.matter_update_request_data_relationships_inner_contact.Matter_update_request_data_relationships_inner_contact(
                            id = 56, ), 
                        id = 56, 
                        _destroy = True, )
                    ],
                ...
                split_invoice_payers = [
                    clio_sdk.models.matter_update_request_data_split_invoice_payers_inner.Matter_update_request_data_split_invoice_payers_inner(
                        contact_id = 56, 
                        id = 56, 
                ...
                status = 'open',
                statute_of_limitations = clio_sdk.models.matter_update_request_data_statute_of_limitations.Matter_update_request_data_statute_of_limitations(
                    status = 'pending', 
                    due_at = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    reminders = [
                        clio_sdk.models.matter_update_request_data_statute_of_limitations_reminders_inner.Matter_update_request_data_statute_of_limitations_reminders_inner(
                            duration_value = 56, 
                            duration_unit = '', 
                            notification_method = clio_sdk.models.matter_update_request_data_statute_of_limitations_reminders_inner_notification_method.Matter_update_request_data_statute_of_limitations_reminders_inner_notification_method(
                                id = 56, ), 
                            id = 56, 
                            _destroy = True, )
                        ], ),
                task_template_list_instances = [
                    clio_sdk.models.matter_update_request_data_task_template_list_instances_inner.Matter_update_request_data_task_template_list_instances_inner(
                        task_template_list = clio_sdk.models.matter_update_request_data_task_template_list_instances_inner_task_template_list.Matter_update_request_data_task_template_list_instances_inner_task_template_list(
                            id = 56, ), 
                        assignee_id = 56, 
