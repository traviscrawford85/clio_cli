    ...
    def make_instance(self, include_optional) -> DocumentTemplateUpdateRequest:
        ...
        if include_optional:
            return DocumentTemplateUpdateRequest(
                data = clio_sdk.models.document_template_update_request_data.DocumentTemplate_update_request_data(
                    document_category = clio_sdk.models.document_template_create_request_data_document_category.DocumentTemplate_create_request_data_document_category(
                        id = 56, ), 
                    file = '', 
                    filename = '', )
            )
