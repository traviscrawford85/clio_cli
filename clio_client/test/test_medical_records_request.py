    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequest:
        ...
        if include_optional:
            return MedicalRecordsRequest(
                ...
                medical_provider = clio_sdk.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
                    ...
                    currency = clio_sdk.models.currency.currency(), ),
                medical_bills = [
                    clio_sdk.models.medical_bill_base.MedicalBill_base(
                        id = 56, 
                        adjustment = 1.337, 
                        amount = 1.337, 
                ...
                medical_records = [
                    clio_sdk.models.medical_record_base.MedicalRecord_base(
                        id = 56, 
                        document_id = 56, 
                        etag = '', 
