    ...
    def make_instance(self, include_optional) -> ActivityCreateRequest:
        ...
        if include_optional:
            return ActivityCreateRequest(
                data = clio_sdk.models.activity_create_request_data.Activity_create_request_data(
                    activity_description = clio_sdk.models.activity_create_request_data_activity_description.Activity_create_request_data_activity_description(
                        id = 56, 
                        utbms_task_id = 56, 
                        utbms_activity_id = 56, ), 
                    calendar_entry = clio_sdk.models.activity_create_request_data_calendar_entry.Activity_create_request_data_calendar_entry(
                        id = 56, ), 
                    client_portal = clio_sdk.models.activity_create_request_data_client_portal.Activity_create_request_data_client_portal(
                        id = 56, ), 
                    communication = clio_sdk.models.activity_create_request_data_communication.Activity_create_request_data_communication(
                        id = 56, ), 
                    contact_note = clio_sdk.models.activity_create_request_data_contact_note.Activity_create_request_data_contact_note(
                        id = 56, ), 
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    expense_category = clio_sdk.models.activity_create_request_data_expense_category.Activity_create_request_data_expense_category(
                        id = 56, ), 
                    matter = clio_sdk.models.activity_create_request_data_matter.Activity_create_request_data_matter(
                        id = 56, ), 
                    matter_note = clio_sdk.models.activity_create_request_data_contact_note.Activity_create_request_data_contact_note(
                        id = 56, ), 
                    no_charge = True, 
                    non_billable = True, 
                    note = '', 
                    ...
                    reference = '', 
                    start_timer = True, 
                    task = clio_sdk.models.activity_create_request_data_task.Activity_create_request_data_task(
                        id = 56, ), 
                    tax_setting = 'no_tax', 
                    text_message_conversation = clio_sdk.models.activity_create_request_data_text_message_conversation.Activity_create_request_data_text_message_conversation(
                        id = 56, ), 
                    type = 'TimeEntry', 
                    user = clio_sdk.models.activity_create_request_data_user.Activity_create_request_data_user(
                        id = 56, ), 
                    utbms_expense = clio_sdk.models.activity_create_request_data_utbms_expense.Activity_create_request_data_utbms_expense(
                        id = 56, ), 
                    vendor = clio_sdk.models.activity_create_request_data_vendor.Activity_create_request_data_vendor(
                        id = 56, ), )
            )
        else:
            return ActivityCreateRequest(
