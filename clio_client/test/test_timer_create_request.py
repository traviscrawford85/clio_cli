    ...
    def make_instance(self, include_optional) -> TimerCreateRequest:
        ...
        if include_optional:
            return TimerCreateRequest(
                data = clio_sdk.models.timer_create_request_data.Timer_create_request_data(
                    activity = clio_sdk.models.timer_create_request_data_activity.Timer_create_request_data_activity(
                        id = 56, ), )
            )
        else:
            return TimerCreateRequest(
