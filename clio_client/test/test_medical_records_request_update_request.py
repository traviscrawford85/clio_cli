    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestUpdateRequest:
        ...
        if include_optional:
            return MedicalRecordsRequestUpdateRequest(
                data = clio_sdk.models.medical_records_request_update_request_data.MedicalRecordsRequest_update_request_data(
                    ...
                    in_treatment = True, 
                    medical_bills = [
                        clio_sdk.models.medical_records_request_update_request_data_medical_bills_inner.MedicalRecordsRequest_update_request_data_medical_bills_inner(
                            adjustment = 1.337, 
                            amount = 1.337, 
                            balance = 1.337, 
                            ...
                            payers = [
                                clio_sdk.models.medical_records_request_update_request_data_medical_bills_inner_payers_inner.MedicalRecordsRequest_update_request_data_medical_bills_inner_payers_inner(
                                    amount = 1.337, 
                                    holder_id = 56, 
                                    mark_as_lien = True, )
                                ], )
                    ...
                    medical_records = [
                        clio_sdk.models.medical_records_request_update_request_data_medical_records_inner.MedicalRecordsRequest_update_request_data_medical_records_inner(
                            document_id = 56, 
