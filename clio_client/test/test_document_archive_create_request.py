    ...
    def make_instance(self, include_optional) -> DocumentArchiveCreateRequest:
        ...
        if include_optional:
            return DocumentArchiveCreateRequest(
                data = clio_sdk.models.document_archive_create_request_data.DocumentArchive_create_request_data(
                    items = [
                        clio_sdk.models.document_archive_create_request_data_items_inner.DocumentArchive_create_request_data_items_inner(
                            id = 56, 
                            type = 56, )
                        ], )
            )
