    ...
    def make_instance(self, include_optional) -> NoteUpdateRequest:
        ...
        if include_optional:
            return NoteUpdateRequest(
                data = clio_sdk.models.note_update_request_data.Note_update_request_data(
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    detail = '', 
                    detail_text_type = 'plain_text', 
                    notification_event_subscribers = [
                        clio_sdk.models.note_update_request_data_notification_event_subscribers_inner.Note_update_request_data_notification_event_subscribers_inner(
                            user_id = '', 
                            id = 56, 
                            _destroy = True, )
                        ], 
