    ...
    def make_instance(self, include_optional) -> NoteCreateRequest:
        ...
        if include_optional:
            return NoteCreateRequest(
                data = clio_sdk.models.note_create_request_data.Note_create_request_data(
                    contact = clio_sdk.models.note_create_request_data_contact.Note_create_request_data_contact(
                        id = 56, ), 
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    detail = '', 
                    detail_text_type = 'plain_text', 
                    matter = clio_sdk.models.note_create_request_data_matter.Note_create_request_data_matter(
                        id = 56, ), 
                    notification_event_subscribers = [
                        clio_sdk.models.note_create_request_data_notification_event_subscribers_inner.Note_create_request_data_notification_event_subscribers_inner(
                            user_id = '', )
                        ], 
                    subject = '', 
                    type = 'Matter', )
