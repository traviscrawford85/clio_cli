    ...
    def make_instance(self, include_optional) -> ActivityDescriptionCreateRequest:
        ...
        if include_optional:
            return ActivityDescriptionCreateRequest(
                data = clio_sdk.models.activity_description_create_request_data.ActivityDescription_create_request_data(
                    currency = clio_sdk.models.currency.currency(), 
                    default = True, 
                    groups = [
                        clio_sdk.models.activity_description_create_request_data_groups_inner.ActivityDescription_create_request_data_groups_inner(
                            id = 56, )
                        ], 
                    name = '', 
