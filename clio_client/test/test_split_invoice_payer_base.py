...
class TestSplitInvoicePayerBase(unittest.TestCase):
    """SplitInvoicePayerBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SplitInvoicePayerBase:
        """Test SplitInvoicePayerBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SplitInvoicePayerBase`
        """
        model = SplitInvoicePayerBase()
        if include_optional:
            return SplitInvoicePayerBase(
                id = 56,
                contact_id = 56,
                matter_id = 56,
    ...
    def testSplitInvoicePayerBase(self):
        """Test SplitInvoicePayerBase"""
