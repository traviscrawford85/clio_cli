    ...
    def make_instance(self, include_optional) -> CommentCreateRequest:
        ...
        if include_optional:
            return CommentCreateRequest(
                data = clio_sdk.models.comment_create_request_data.Comment_create_request_data(
                    item = clio_sdk.models.comment_create_request_data_item.Comment_create_request_data_item(
                        id = 56, ), 
                    message = '', )
            )
        else:
