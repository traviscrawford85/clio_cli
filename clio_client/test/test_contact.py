        ...
        if include_optional:
            return Contact(
                ...
                currency = clio_sdk.models.currency_base.Currency_base(
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                activity_rates = [
                    clio_sdk.models.activity_rate_base.ActivityRate_base(
                        id = 56, 
                        etag = '', 
                        rate = 1.337, 
                        flat_rate = True, 
                ...
                email_addresses = [
                    clio_sdk.models.email_address_base.EmailAddress_base(
                        id = 56, 
                        etag = '', 
                        address = '', 
                        name = '', 
                ...
                instant_messengers = [
                    clio_sdk.models.instant_messenger_base.InstantMessenger_base(
                        id = 56, 
                        etag = '', 
                        address = '', 
                        name = 'Work', 
                ...
                phone_numbers = [
                    clio_sdk.models.phone_number_base.PhoneNumber_base(
                        id = 56, 
                        etag = '', 
                        number = '', 
                        name = 'Work', 
                ...
                web_sites = [
                    clio_sdk.models.web_site_base.WebSite_base(
                        id = 56, 
                        etag = '', 
                        address = '', 
                        name = 'Work', 
                ...
                notification_methods = [
                    clio_sdk.models.notification_method_base.NotificationMethod_base(
                        id = 56, 
                        etag = '', 
                        type = 'Email', 
                        email_address = '', 
                ...
                related_contacts = [
                    clio_sdk.models.contact_base.Contact_base(
                        id = 56, 
                        etag = '', 
                        name = '', 
                        first_name = '', 
                ...
                primary_work_address = clio_sdk.models.address_base.Address_base(
                    id = 56, 
                    etag = '', 
                    street = '', 
                    city = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                primary_address = clio_sdk.models.address_base.Address_base(
                    id = 56, 
                    etag = '', 
                    street = '', 
                    city = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                secondary_address = clio_sdk.models.address_base.Address_base(
                    id = 56, 
                    etag = '', 
                    street = '', 
                    city = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                company = clio_sdk.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
                    ...
                    sales_tax_number = '', 
                    currency = clio_sdk.models.currency.currency(), ),
                avatar = clio_sdk.models.avatar_base.Avatar_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    url = '', 
                    _destroy = True, ),
                payment_profile = clio_sdk.models.payment_profile_base.PaymentProfile_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                folder = clio_sdk.models.folder_base.Folder_base(
                    ...
                    name = '', 
                    root = True, ),
                co_counsel_rate = clio_sdk.models.activity_rate_base.ActivityRate_base(
                    id = 56, 
                    etag = '', 
                    rate = 1.337, 
                    flat_rate = True, 
                    ...
                    contact_id = 56, 
                    co_counsel_contact_id = 56, ),
                primary_web_site = clio_sdk.models.web_site_base.WebSite_base(
                    id = 56, 
                    etag = '', 
                    address = '', 
                    name = 'Work', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                legal_aid_uk_contact = clio_sdk.models.legal_aid_uk_contact_base.LegalAidUkContact_base(
                    id = 56, 
                    disability = 56, 
                    disability_code = '', 
                    ethnicity = 56, 
