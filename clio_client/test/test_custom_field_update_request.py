    ...
    def make_instance(self, include_optional) -> CustomFieldUpdateRequest:
        ...
        if include_optional:
            return CustomFieldUpdateRequest(
                data = clio_sdk.models.custom_field_update_request_data.CustomField_update_request_data(
                    display_order = 56, 
                    displayed = True, 
                    name = '', 
                    picklist_options = [
                        clio_sdk.models.custom_field_create_request_data_picklist_options_inner.CustomField_create_request_data_picklist_options_inner(
                            id = 56, 
                            option = '', 
                            _deleted = True, )
                        ], 
