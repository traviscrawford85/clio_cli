    ...
    def make_instance(self, include_optional) -> CommunicationUpdateRequest:
        ...
        if include_optional:
            return CommunicationUpdateRequest(
                data = clio_sdk.models.communication_update_request_data.Communication_update_request_data(
                    body = '', 
                    date = '', 
                    external_properties = [
                        clio_sdk.models.communication_update_request_data_external_properties_inner.Communication_update_request_data_external_properties_inner(
                            id = 56, 
                            name = '', 
                            value = '', 
                            _destroy = True, )
                    ...
                    notification_event_subscribers = [
                        clio_sdk.models.communication_update_request_data_notification_event_subscribers_inner.Communication_update_request_data_notification_event_subscribers_inner(
                            user_id = '', 
                            id = 56, 
                            _destroy = True, )
                        ], 
