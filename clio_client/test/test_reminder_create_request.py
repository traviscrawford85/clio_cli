    ...
    def make_instance(self, include_optional) -> ReminderCreateRequest:
        ...
        if include_optional:
            return ReminderCreateRequest(
                data = clio_sdk.models.reminder_create_request_data.Reminder_create_request_data(
                    duration_unit = 'weeks', 
                    duration_value = 56, 
                    notification_method = clio_sdk.models.matter_create_request_data_statute_of_limitations_reminders_inner_notification_method.Matter_create_request_data_statute_of_limitations_reminders_inner_notification_method(
                        id = 56, ), 
                    subject = clio_sdk.models.reminder_create_request_data_subject.Reminder_create_request_data_subject(
                        id = 56, 
                        type = 'CalendarEntry', ), )
            )
        else:
