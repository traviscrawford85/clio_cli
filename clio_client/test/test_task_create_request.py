    ...
    def make_instance(self, include_optional) -> TaskCreateRequest:
        ...
        if include_optional:
            return TaskCreateRequest(
                data = clio_sdk.models.task_create_request_data.Task_create_request_data(
                    assignee = clio_sdk.models.task_create_request_data_assignee.Task_create_request_data_assignee(
                        id = 56, 
                        type = 'User', ), 
                    cascading = True, 
                    cascading_offset = 56, 
                    ...
                    matter = clio_sdk.models.task_create_request_data_matter.Task_create_request_data_matter(
                        id = 56, ), 
                    name = '', 
                    ...
                    task_type = clio_sdk.models.task_create_request_data_task_type.Task_create_request_data_task_type(
                        id = 56, ), 
                    time_estimated = 56, )
            )
        else:
