    ...
    def make_instance(self, include_optional) -> CommunicationCreateRequest:
        ...
        if include_optional:
            return CommunicationCreateRequest(
                data = clio_sdk.models.communication_create_request_data.Communication_create_request_data(
                    body = '', 
                    date = '', 
                    external_properties = [
                        clio_sdk.models.communication_create_request_data_external_properties_inner.Communication_create_request_data_external_properties_inner(
                            name = '', 
                            value = '', )
                        ], 
                    matter = clio_sdk.models.communication_create_request_data_matter.Communication_create_request_data_matter(
                        id = 56, ), 
                    notification_event_subscribers = [
                        clio_sdk.models.communication_create_request_data_notification_event_subscribers_inner.Communication_create_request_data_notification_event_subscribers_inner(
                            user_id = '', )
                        ], 
                    received_at = '', 
                    receivers = [
                        clio_sdk.models.communication_create_request_data_receivers_inner.Communication_create_request_data_receivers_inner(
                            _deleted = True, 
                            id = 56, 
                            type = 'User', )
                        ], 
                    senders = [
                        clio_sdk.models.communication_create_request_data_senders_inner.Communication_create_request_data_senders_inner(
                            _deleted = True, 
                            id = 56, 
                            type = 'User', )
                        ], 
