...
from openapi_server.apis.bank_transfers_api_base import BaseBankTransfersApi
...
@router.get(
    ...
    responses={
        200: {"model": BankTransferShow, "description": "Ok"},
...
async def bank_transfer_show(
    id: Annotated[StrictInt, Field(description="The unique identifier for the BankTransfer.")] = Path(..., description="The unique identifier for the BankTransfer."),
    ...
    return await BaseBankTransfersApi.subclasses[0]().bank_transfer_show(id, if_modified_since, if_none_match, x_api_version, fields)
