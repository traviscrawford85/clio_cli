...
class OutstandingClientBalance(BaseModel):
    ...
    total_outstanding_balance_by_currency: Optional[Dict[str, Any]] = Field(default=None, description="Outstanding Balances by Currency")
    ...
    __properties: ClassVar[List[str]] = ["associated_matter_ids", "etag", "id", "last_payment_date", "last_shared_date", "newest_issued_bill_due_date", "pending_payments_total", "reminders_enabled", "total_outstanding_balance", "total_outstanding_balance_by_currency", "created_at", "updated_at", "outstanding_bills", "contact", "currency"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "total_outstanding_balance_by_currency": obj.get("total_outstanding_balance_by_currency"),
