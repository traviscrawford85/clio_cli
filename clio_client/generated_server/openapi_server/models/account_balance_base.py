...
class AccountBalanceBase(BaseModel):
    ...
    currency_id: Optional[StrictInt] = Field(default=None, description="The currency ID of the bank account")
    __properties: ClassVar[List[str]] = ["id", "balance", "type", "name", "currency_id"]
