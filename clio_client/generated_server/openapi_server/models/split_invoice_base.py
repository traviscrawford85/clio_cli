...
class SplitInvoiceBase(BaseModel):
    ...
    SplitInvoiceBase
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *SplitInvoice*")
    bill_id: Optional[StrictInt] = Field(default=None, description="The ID of the bill that was split.")
    linked_invoices_display_numbers: Optional[List[StrictStr]] = Field(default=None, description="Display numbers of all invoices split with this one.")
    linked_invoices_ids: Optional[List[StrictInt]] = Field(default=None, description="IDs of all invoices split with this one.")
    split_connection_id: Optional[StrictStr] = Field(default=None, description="UUID to determine which invoices are split together.")
    split_portion: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The percentage of the bill that the payer is responsible for.")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *SplitInvoice*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *SplitInvoice* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *SplitInvoice* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[List[str]] = ["id", "bill_id", "linked_invoices_display_numbers", "linked_invoices_ids", "split_connection_id", "split_portion", "etag", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "linked_invoices_display_numbers": obj.get("linked_invoices_display_numbers"),
            "linked_invoices_ids": obj.get("linked_invoices_ids"),
            "split_connection_id": obj.get("split_connection_id"),
