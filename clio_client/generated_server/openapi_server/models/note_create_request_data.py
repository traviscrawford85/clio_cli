...
class NoteCreateRequestData(BaseModel):
    ...
    detail: Optional[StrictStr] = Field(default=None, description="Note body in text. This Note supports rich text when setting the `detail_text_type` field to `rich_text`.With supported tags such as `<a>`, `<b>`, `<br>`, `<div>`, `<em>`, `<i>` `<li>`, `<ol>`, `<p>`, `<s>`, `<strong>`, `<u>` and `<ul>`. This Note also supports attributes such as `href`, `rel`, `type`, `target` and `style`.")
