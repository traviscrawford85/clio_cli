...
class TaskBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "etag", "name", "status", "description", "description_text_type", "priority", "due_at", "permission", "completed_at", "notify_completion", "statute_of_limitations", "time_estimated", "created_at", "updated_at", "time_entries_count"]
