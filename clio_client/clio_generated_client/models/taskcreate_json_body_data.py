...
from ..models.taskcreate_json_body_data_cascading_offset_polarity import TaskcreateJsonBodyDataCascadingOffsetPolarity
from ..models.taskcreate_json_body_data_cascading_offset_type import TaskcreateJsonBodyDataCascadingOffsetType
from ..models.taskcreate_json_body_data_description_text_type import TaskcreateJsonBodyDataDescriptionTextType
from ..models.taskcreate_json_body_data_permission import TaskcreateJsonBodyDataPermission
...
class TaskcreateJsonBodyData:
    ...
    Attributes:
        ...
        cascading_source (Union[Unset, int]): The parent Task that is used to determine the due_at property of the
            cascaded Task
        description_text_type (Union[Unset, TaskcreateJsonBodyDataDescriptionTextType]): The type of text in the
            description field. Default: TaskcreateJsonBodyDataDescriptionTextType.PLAIN_TEXT.
    ...
    description_text_type: Union[Unset, TaskcreateJsonBodyDataDescriptionTextType] = (
        TaskcreateJsonBodyDataDescriptionTextType.PLAIN_TEXT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description_text_type, Unset):
            ...
            description_text_type = TaskcreateJsonBodyDataDescriptionTextType(_description_text_type)
