...
if TYPE_CHECKING:
    ...
    from ..models.contactcreate_files_body_data_currency import ContactcreateFilesBodyDataCurrency
...
class ContactcreateFilesBodyData:
    ...
    Attributes:
        ...
        currency (Union[Unset, ContactcreateFilesBodyDataCurrency]): The Currency the contact is associated with.
    ...
    currency: Union[Unset, "ContactcreateFilesBodyDataCurrency"] = UNSET
    custom_field_set_associations: Union[Unset, list["ContactcreateFilesBodyDataCustomFieldSetAssociationsItem"]] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        currency: Union[Unset, ContactcreateFilesBodyDataCurrency]
        if isinstance(_currency, Unset):
            currency = UNSET
        else:
            currency = ContactcreateFilesBodyDataCurrency.from_dict(_currency)
