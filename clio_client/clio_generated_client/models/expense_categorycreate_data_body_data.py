...
from ..models.expense_categorycreate_data_body_data_entry_type import ExpenseCategorycreateDataBodyDataEntryType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.expense_categorycreate_data_body_data_currency import ExpenseCategorycreateDataBodyDataCurrency
...
class ExpenseCategorycreateDataBodyData:
    ...
    Attributes:
        ...
        currency (Union[Unset, ExpenseCategorycreateDataBodyDataCurrency]): Currency of the Expense Category.
    ...
    name: str
    currency: Union[Unset, "ExpenseCategorycreateDataBodyDataCurrency"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        currency: Union[Unset, ExpenseCategorycreateDataBodyDataCurrency]
        if isinstance(_currency, Unset):
            currency = UNSET
        else:
            currency = ExpenseCategorycreateDataBodyDataCurrency.from_dict(_currency)
