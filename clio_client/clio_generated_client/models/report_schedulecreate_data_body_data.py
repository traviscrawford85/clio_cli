...
from ..models.report_schedulecreate_data_body_data_frequency import ReportSchedulecreateDataBodyDataFrequency
from ..models.report_schedulecreate_data_body_data_time_zone_type_1 import ReportSchedulecreateDataBodyDataTimeZoneType1
...
class ReportSchedulecreateDataBodyData:
    ...
    Attributes:
        ...
        time_zone (Union[None, ReportSchedulecreateDataBodyDataTimeZoneType1]): Used in conjunction with `time_of_day`
    ...
    time_zone: Union[None, ReportSchedulecreateDataBodyDataTimeZoneType1]
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.time_zone, ReportSchedulecreateDataBodyDataTimeZoneType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_time_zone(data: object) -> Union[None, ReportSchedulecreateDataBodyDataTimeZoneType1]:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                time_zone_type_1 = ReportSchedulecreateDataBodyDataTimeZoneType1(data)

                return time_zone_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, ReportSchedulecreateDataBodyDataTimeZoneType1], data)
