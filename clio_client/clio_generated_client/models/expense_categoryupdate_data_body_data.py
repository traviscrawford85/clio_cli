...
from ..models.expense_categoryupdate_data_body_data_entry_type import ExpenseCategoryupdateDataBodyDataEntryType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.expense_categoryupdate_data_body_data_currency import ExpenseCategoryupdateDataBodyDataCurrency
...
class ExpenseCategoryupdateDataBodyData:
    """
    Attributes:
        currency (Union[Unset, ExpenseCategoryupdateDataBodyDataCurrency]): Currency of the Expense Category.
    ...
    currency: Union[Unset, "ExpenseCategoryupdateDataBodyDataCurrency"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        currency: Union[Unset, ExpenseCategoryupdateDataBodyDataCurrency]
        if isinstance(_currency, Unset):
            currency = UNSET
        else:
            currency = ExpenseCategoryupdateDataBodyDataCurrency.from_dict(_currency)
