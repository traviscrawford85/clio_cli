...
class Document:
    ...
    Attributes:
        ...
        latest_document_version (Union[Unset, DocumentVersion]):
    ...
    latest_document_version: Union[Unset, "DocumentVersion"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_latest_document_version, Unset):
            ...
            latest_document_version = DocumentVersion.from_dict(_latest_document_version)
