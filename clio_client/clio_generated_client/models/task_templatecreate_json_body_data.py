...
from ..models.task_templatecreate_json_body_data_description_text_type import (
    TaskTemplatecreateJsonBodyDataDescriptionTextType,
)
from ..models.task_templatecreate_json_body_data_priority import TaskTemplatecreateJsonBodyDataPriority
...
class TaskTemplatecreateJsonBodyData:
    ...
    Attributes:
        ...
        description_text_type (Union[Unset, TaskTemplatecreateJsonBodyDataDescriptionTextType]): The type of text in the
            description field. Default: TaskTemplatecreateJsonBodyDataDescriptionTextType.PLAIN_TEXT.
    ...
    description_text_type: Union[Unset, TaskTemplatecreateJsonBodyDataDescriptionTextType] = (
        TaskTemplatecreateJsonBodyDataDescriptionTextType.PLAIN_TEXT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description_text_type, Unset):
            ...
            description_text_type = TaskTemplatecreateJsonBodyDataDescriptionTextType(_description_text_type)
