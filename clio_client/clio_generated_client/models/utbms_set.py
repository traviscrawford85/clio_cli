...
class UtbmsSet:
    ...
    Attributes:
        ...
        created_at (Union[Unset, datetime.datetime]): The time the *UtbmsSet* was created (as a ISO-8601 timestamp)
        updated_at (Union[Unset, datetime.datetime]): The time the *UtbmsSet* was last updated (as a ISO-8601 timestamp)
    """
