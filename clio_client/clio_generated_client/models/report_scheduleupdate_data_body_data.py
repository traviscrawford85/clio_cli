...
from ..models.report_scheduleupdate_data_body_data_frequency import ReportScheduleupdateDataBodyDataFrequency
from ..models.report_scheduleupdate_data_body_data_time_zone_type_1 import ReportScheduleupdateDataBodyDataTimeZoneType1
...
class ReportScheduleupdateDataBodyData:
    ...
    Attributes:
        ...
        time_zone (Union[None, ReportScheduleupdateDataBodyDataTimeZoneType1, Unset]): Used in conjunction with
    ...
    time_zone: Union[None, ReportScheduleupdateDataBodyDataTimeZoneType1, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.time_zone, Unset):
            time_zone = UNSET
        elif isinstance(self.time_zone, ReportScheduleupdateDataBodyDataTimeZoneType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_time_zone(data: object) -> Union[None, ReportScheduleupdateDataBodyDataTimeZoneType1, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                time_zone_type_1 = ReportScheduleupdateDataBodyDataTimeZoneType1(data)

                return time_zone_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, ReportScheduleupdateDataBodyDataTimeZoneType1, Unset], data)
