...
from ..models.taskcreate_files_body_data_cascading_offset_polarity import TaskcreateFilesBodyDataCascadingOffsetPolarity
from ..models.taskcreate_files_body_data_cascading_offset_type import TaskcreateFilesBodyDataCascadingOffsetType
from ..models.taskcreate_files_body_data_description_text_type import TaskcreateFilesBodyDataDescriptionTextType
from ..models.taskcreate_files_body_data_permission import TaskcreateFilesBodyDataPermission
...
class TaskcreateFilesBodyData:
    ...
    Attributes:
        ...
        cascading_source (Union[Unset, int]): The parent Task that is used to determine the due_at property of the
            cascaded Task
        description_text_type (Union[Unset, TaskcreateFilesBodyDataDescriptionTextType]): The type of text in the
            description field. Default: TaskcreateFilesBodyDataDescriptionTextType.PLAIN_TEXT.
    ...
    description_text_type: Union[Unset, TaskcreateFilesBodyDataDescriptionTextType] = (
        TaskcreateFilesBodyDataDescriptionTextType.PLAIN_TEXT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description_text_type, Unset):
            ...
            description_text_type = TaskcreateFilesBodyDataDescriptionTextType(_description_text_type)
