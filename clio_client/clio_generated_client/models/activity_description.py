...
if TYPE_CHECKING:
    ...
    from ..models.activity_description_rate_base import ActivityDescriptionRateBase
...
class ActivityDescription:
    ...
    Attributes:
        ...
        rate (Union[Unset, ActivityDescriptionRateBase]):
        utbms_task (Union[Unset, UtbmsCodeBase]):
        utbms_activity (Union[Unset, UtbmsCodeBase]):
    """
    ...
    rate: Union[Unset, "ActivityDescriptionRateBase"] = UNSET
    utbms_task: Union[Unset, "UtbmsCodeBase"] = UNSET
    utbms_activity: Union[Unset, "UtbmsCodeBase"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_rate, Unset):
            ...
            rate = ActivityDescriptionRateBase.from_dict(_rate)
        ...
        if isinstance(_utbms_task, Unset):
            ...
            utbms_task = UtbmsCodeBase.from_dict(_utbms_task)
        ...
        if isinstance(_utbms_activity, Unset):
            ...
            utbms_activity = UtbmsCodeBase.from_dict(_utbms_activity)
