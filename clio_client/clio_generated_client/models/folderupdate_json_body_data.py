...
if TYPE_CHECKING:
    from ..models.folderupdate_json_body_data_document_category import FolderupdateJsonBodyDataDocumentCategory
    from ..models.folderupdate_json_body_data_external_properties_item import (
        FolderupdateJsonBodyDataExternalPropertiesItem,
    )
    from ..models.folderupdate_json_body_data_parent import FolderupdateJsonBodyDataParent
