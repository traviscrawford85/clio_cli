...
if TYPE_CHECKING:
    ...
    from ..models.mattercreate_json_body_data_currency import MattercreateJsonBodyDataCurrency
    ...
    from ..models.mattercreate_json_body_data_responsible_staff import MattercreateJsonBodyDataResponsibleStaff
...
class MattercreateJsonBodyData:
    ...
    Attributes:
        ...
        currency (Union[Unset, MattercreateJsonBodyDataCurrency]): Currency of the matter
        ...
        responsible_staff (Union[Unset, MattercreateJsonBodyDataResponsibleStaff]):
    ...
    currency: Union[Unset, "MattercreateJsonBodyDataCurrency"] = UNSET
    ...
    responsible_staff: Union[Unset, "MattercreateJsonBodyDataResponsibleStaff"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        currency: Union[Unset, MattercreateJsonBodyDataCurrency]
        if isinstance(_currency, Unset):
            currency = UNSET
        else:
            currency = MattercreateJsonBodyDataCurrency.from_dict(_currency)
        ...
        if isinstance(_responsible_staff, Unset):
            ...
            responsible_staff = MattercreateJsonBodyDataResponsibleStaff.from_dict(_responsible_staff)
