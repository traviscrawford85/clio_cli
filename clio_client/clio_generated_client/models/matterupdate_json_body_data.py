...
if TYPE_CHECKING:
    ...
    from ..models.matterupdate_json_body_data_currency import MatterupdateJsonBodyDataCurrency
    ...
    from ..models.matterupdate_json_body_data_responsible_staff import MatterupdateJsonBodyDataResponsibleStaff
...
class MatterupdateJsonBodyData:
    ...
    Attributes:
        ...
        currency (Union[Unset, MatterupdateJsonBodyDataCurrency]): Currency of the matter
        ...
        responsible_staff (Union[Unset, MatterupdateJsonBodyDataResponsibleStaff]):
    ...
    currency: Union[Unset, "MatterupdateJsonBodyDataCurrency"] = UNSET
    ...
    responsible_staff: Union[Unset, "MatterupdateJsonBodyDataResponsibleStaff"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        currency: Union[Unset, MatterupdateJsonBodyDataCurrency]
        if isinstance(_currency, Unset):
            currency = UNSET
        else:
            currency = MatterupdateJsonBodyDataCurrency.from_dict(_currency)
        ...
        if isinstance(_responsible_staff, Unset):
            ...
            responsible_staff = MatterupdateJsonBodyDataResponsibleStaff.from_dict(_responsible_staff)
