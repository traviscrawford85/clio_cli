...
from ..models.task_templateupdate_json_body_data_description_text_type import (
    TaskTemplateupdateJsonBodyDataDescriptionTextType,
)
from ..models.task_templateupdate_json_body_data_priority import TaskTemplateupdateJsonBodyDataPriority
...
class TaskTemplateupdateJsonBodyData:
    ...
    Attributes:
        ...
        description_text_type (Union[Unset, TaskTemplateupdateJsonBodyDataDescriptionTextType]): The type of text in the
            description field. Default: TaskTemplateupdateJsonBodyDataDescriptionTextType.PLAIN_TEXT.
    ...
    description_text_type: Union[Unset, TaskTemplateupdateJsonBodyDataDescriptionTextType] = (
        TaskTemplateupdateJsonBodyDataDescriptionTextType.PLAIN_TEXT
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description_text_type, Unset):
            ...
            description_text_type = TaskTemplateupdateJsonBodyDataDescriptionTextType(_description_text_type)
