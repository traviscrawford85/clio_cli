...
class NotificationEventSubscriberBase:
    ...
    Attributes:
        ...
        name (Union[Unset, str]): The User name added as a notification event subscriber to the
            NotificationEventSubscriber
        created_at (Union[Unset, datetime.datetime]): The time the *NotificationEventSubscriber* was created (as a
            ISO-8601 timestamp)
        updated_at (Union[Unset, datetime.datetime]): The time the *NotificationEventSubscriber* was last updated (as a
            ISO-8601 timestamp)
    """
