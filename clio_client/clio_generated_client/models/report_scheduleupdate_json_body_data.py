...
from ..models.report_scheduleupdate_json_body_data_frequency import ReportScheduleupdateJsonBodyDataFrequency
from ..models.report_scheduleupdate_json_body_data_time_zone_type_1 import ReportScheduleupdateJsonBodyDataTimeZoneType1
...
class ReportScheduleupdateJsonBodyData:
    ...
    Attributes:
        ...
        time_zone (Union[None, ReportScheduleupdateJsonBodyDataTimeZoneType1, Unset]): Used in conjunction with
    ...
    time_zone: Union[None, ReportScheduleupdateJsonBodyDataTimeZoneType1, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.time_zone, Unset):
            time_zone = UNSET
        elif isinstance(self.time_zone, ReportScheduleupdateJsonBodyDataTimeZoneType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_time_zone(data: object) -> Union[None, ReportScheduleupdateJsonBodyDataTimeZoneType1, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                time_zone_type_1 = ReportScheduleupdateJsonBodyDataTimeZoneType1(data)

                return time_zone_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, ReportScheduleupdateJsonBodyDataTimeZoneType1, Unset], data)
