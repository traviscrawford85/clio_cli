...
def _get_kwargs(
    *,
    ...
    json_treatment_end_date: Union[Unset, str] = UNSET
    if not isinstance(treatment_end_date, Unset):
        json_treatment_end_date = treatment_end_date.isoformat()
    params["treatment_end_date"] = json_treatment_end_date

    json_treatment_start_date: Union[Unset, str] = UNSET
    if not isinstance(treatment_start_date, Unset):
        json_treatment_start_date = treatment_start_date.isoformat()
    params["treatment_start_date"] = json_treatment_start_date
