...
from ...models.phone_number_list import PhoneNumberList
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/contacts/{contact_id}/phone_numbers",
        "params": params,
    }
...
) -> Optional[Union[Error, PhoneNumberList]]:
    if response.status_code == 200:
        response_200 = PhoneNumberList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, PhoneNumberList]]:
    return Response(
