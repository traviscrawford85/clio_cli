...
from ...models.email_address_list import EmailAddressList
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/contacts/{contact_id}/email_addresses",
        "params": params,
    }
...
) -> Optional[Union[EmailAddressList, Error]]:
    if response.status_code == 200:
        response_200 = EmailAddressList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[EmailAddressList, Error]]:
    return Response(
