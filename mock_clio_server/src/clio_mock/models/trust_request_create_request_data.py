...
from clio_mock.models.trust_request_create_request_data_matter_inner import TrustRequestCreateRequestDataMatterInner
try:
...
class TrustRequestCreateRequestData(BaseModel):
    ...
    currency_id: Optional[StrictInt] = Field(default=None, description="The currency_id associated to the TrustRequest")
    ...
    __properties: ClassVar[List[str]] = ["approved", "client_id", "currency_id", "due_date", "issue_date", "matter", "note", "trust_amount", "trust_type"]
