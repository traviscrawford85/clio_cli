...
from clio_mock.models.task_create_request_data_assignee import TaskCreateRequestDataAssignee
from clio_mock.models.task_create_request_data_matter import TaskCreateRequestDataMatter
from clio_mock.models.task_create_request_data_task_type import TaskCreateRequestDataTaskType
try:
...
class TaskCreateRequestData(BaseModel):
    ...
    description: StrictStr = Field(description="Longer description of the Task. This Task supports rich text when the `description_text_type` field is set to `rich_text`. With supported tags such as `<a>`, `<b>`, `<br>`, `<div>`, `<em>`, `<i>` `<li>`, `<ol>`, `<p>`, `<s>`, `<strong>`, `<u>` and `<ul>`. This Task also supports attributes such as `href`, `rel`, `type`, and `target`.")
    ...
    __properties: ClassVar[List[str]] = ["assignee", "cascading", "cascading_offset", "cascading_offset_polarity", "cascading_offset_type", "cascading_source", "description", "description_text_type", "due_at", "matter", "name", "notify_assignee", "notify_completion", "permission", "priority", "status", "statute_of_limitations", "task_type", "time_estimated"]
