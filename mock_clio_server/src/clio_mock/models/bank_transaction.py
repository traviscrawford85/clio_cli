...
from clio_mock.models.allocation_base import AllocationBase
...
class BankTransaction(BaseModel):
    ...
    currency_id: Optional[StrictInt] = Field(default=None, description="The id of the currency of the transaction.")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "etag", "created_at", "updated_at", "bank_account_id", "source", "confirmation", "date", "amount", "currency", "currency_id", "description", "exchange_rate", "transaction_type", "funds_in", "funds_out", "clio_payments_transaction", "current_account_balance", "read_only_confirmation", "client", "matter", "bank_account", "bill", "allocation"]
