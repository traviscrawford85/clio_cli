...
class SplitInvoicePayerBase(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *SplitInvoicePayer*")
    contact_id: Optional[StrictInt] = Field(default=None, description="The ID of the payer for the split invoice.")
    matter_id: Optional[StrictInt] = Field(default=None, description="The ID of the Matter that has split invoicing enabled.")
    send_to_bill_recipients: Optional[StrictBool] = Field(default=None, description="Boolean to indicate if the sent bills should include bill recipients by default.")
    ...
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *SplitInvoicePayer*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *SplitInvoicePayer* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *SplitInvoicePayer* was last updated (as a ISO-8601 timestamp)")
    __properties: ClassVar[List[str]] = ["id", "contact_id", "matter_id", "send_to_bill_recipients", "split_portion", "etag", "created_at", "updated_at"]
