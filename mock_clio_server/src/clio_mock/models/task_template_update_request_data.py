...
from clio_mock.models.task_template_update_request_data_reminder_templates_inner import TaskTemplateUpdateRequestDataReminderTemplatesInner
try:
...
class TaskTemplateUpdateRequestData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cascading", "cascading_offset", "cascading_offset_polarity", "cascading_offset_type", "cascading_source", "description", "description_text_type", "name", "priority", "private", "reminder_templates"]
