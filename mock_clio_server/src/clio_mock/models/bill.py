...
from clio_mock.models.address_base import AddressBase
from clio_mock.models.balance_base import BalanceBase
from clio_mock.models.bank_account_base import BankAccountBase
from clio_mock.models.bill_base import BillBase
from clio_mock.models.bill_theme_base import BillThemeBase
from clio_mock.models.billing_setting_base import BillingSettingBase
from clio_mock.models.contact_base import ContactBase
from clio_mock.models.currency_base import CurrencyBase
from clio_mock.models.discount_base import DiscountBase
from clio_mock.models.group_base import GroupBase
from clio_mock.models.interest_base import InterestBase
from clio_mock.models.legal_aid_uk_bill_base import LegalAidUkBillBase
from clio_mock.models.matter_balance_base import MatterBalanceBase
from clio_mock.models.matter_base import MatterBase
from clio_mock.models.split_invoice_base import SplitInvoiceBase
...
class Bill(BaseModel):
    ...
    def available_state_transitions_validate_enum(cls, value):
        ...
        for i in value:
            if i not in ('awaiting_approval', 'awaiting_payment', 'paid', 'void', 'deleted',):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of split_invoice
        if self.split_invoice:
            _dict['split_invoice'] = self.split_invoice.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "split_invoice": SplitInvoiceBase.from_dict(obj.get("split_invoice")) if obj.get("split_invoice") is not None else None
        })
        return _obj
