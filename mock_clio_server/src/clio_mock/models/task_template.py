...
from clio_mock.models.cascading_task_template_base import CascadingTaskTemplateBase
from clio_mock.models.reminder_template_base import ReminderTemplateBase
from clio_mock.models.task_template_list_base import TaskTemplateListBase
...
class TaskTemplate(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="The text body of the *TaskTemplate*. This TaskTemplate supports rich text when setting the field `detail_text_type` to `rich_text`. With supported tags such as `<a>`, `<b>`, `<br>`, `<div>`, `<em>`, `<i>` `<li>`, `<ol>`, `<p>`, `<s>`, `<strong>`, `<u>` and `<ul>`. This TaskTemplate also supports attributes such as `href`, `rel`, `type`, and `target`.")
    description_text_type: Optional[StrictStr] = Field(default=None, description="The type of text in the description field.")
    ...
    __properties: ClassVar[List[str]] = ["id", "etag", "name", "description", "description_text_type", "priority", "private", "created_at", "updated_at", "cascading_source", "assignee", "task_template_list", "task_type", "template_creator", "reminder_templates"]
