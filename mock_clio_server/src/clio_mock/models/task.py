...
from clio_mock.models.activity_base import ActivityBase
from clio_mock.models.matter_base import MatterBase
from clio_mock.models.participant import Participant
from clio_mock.models.reminder_base import ReminderBase
from clio_mock.models.task_type_base import TaskTypeBase
...
class Task(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of the *Task*. This Task supports rich text when setting the field `description_text_type` to `rich_text`. With supported tags such as `<a>`, `<b>`, `<br>`, `<div>`, `<em>`, `<i>` `<li>`, `<ol>`, `<p>`, `<s>`, `<strong>`, `<u>` and `<ul>`. This Task also supports attributes such as `href`, `rel`, `type`, and `target`.")
    description_text_type: Optional[StrictStr] = Field(default=None, description="The text type of the *Task*")
    ...
    __properties: ClassVar[List[str]] = ["id", "etag", "name", "status", "description", "description_text_type", "priority", "due_at", "permission", "completed_at", "notify_completion", "statute_of_limitations", "time_estimated", "created_at", "updated_at", "time_entries_count", "time_entries", "task_type", "assigner", "matter", "assignee", "reminders"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "description_text_type": obj.get("description_text_type"),
