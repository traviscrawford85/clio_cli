...
from clio_mock.models.account_balance_base import AccountBalanceBase
from clio_mock.models.contact_base import ContactBase
from clio_mock.models.contingency_fee_base import ContingencyFeeBase
from clio_mock.models.currency_base import CurrencyBase
from clio_mock.models.custom_field_set_association_base import CustomFieldSetAssociationBase
from clio_mock.models.custom_field_value import CustomFieldValue
from clio_mock.models.evergreen_retainer_base import EvergreenRetainerBase
from clio_mock.models.folder_base import FolderBase
from clio_mock.models.group_base import GroupBase
from clio_mock.models.legal_aid_uk_matter_base import LegalAidUkMatterBase
from clio_mock.models.matter_bill_recipient import MatterBillRecipient
from clio_mock.models.matter_budget_base import MatterBudgetBase
from clio_mock.models.matter_custom_rate import MatterCustomRate
from clio_mock.models.matter_stage_base import MatterStageBase
from clio_mock.models.practice_area_base import PracticeAreaBase
from clio_mock.models.relationship_base import RelationshipBase
from clio_mock.models.split_invoice_payer_base import SplitInvoicePayerBase
from clio_mock.models.task_base import TaskBase
from clio_mock.models.task_template_list_instace_base import TaskTemplateListInstaceBase
from clio_mock.models.user_base import UserBase
try:
...
class Matter(BaseModel):
    ...
    responsible_staff: Optional[UserBase] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "responsible_staff": UserBase.from_dict(obj.get("responsible_staff")) if obj.get("responsible_staff") is not None else None,
            ...
            "split_invoice_payers": [SplitInvoicePayerBase.from_dict(_item) for _item in obj.get("split_invoice_payers")] if obj.get("split_invoice_payers") is not None else None
        })
        return _obj
