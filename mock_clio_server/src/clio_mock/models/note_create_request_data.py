...
from clio_mock.models.note_create_request_data_contact import NoteCreateRequestDataContact
from clio_mock.models.note_create_request_data_matter import NoteCreateRequestDataMatter
from clio_mock.models.note_create_request_data_notification_event_subscribers_inner import NoteCreateRequestDataNotificationEventSubscribersInner
try:
...
class NoteCreateRequestData(BaseModel):
    ...
    detail: Optional[StrictStr] = Field(default=None, description="Note body in text. This Note supports rich text when setting the `detail_text_type` field to `rich_text`. With supported tags such as `<a>`, `<b>`, `<br>`, `<div>`, `<em>`, `<i>` `<li>`, `<ol>`, `<p>`, `<s>`, `<strong>`, `<u>` and `<ul>`. This Note also supports attributes such as `href`, `rel`, `type`, and `target`.")
    detail_text_type: Optional[StrictStr] = Field(default='plain_text', description="The type of text in the detail field.")
    ...
    __properties: ClassVar[List[str]] = ["contact", "date", "detail", "detail_text_type", "matter", "notification_event_subscribers", "subject", "type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "detail_text_type": obj.get("detail_text_type") if obj.get("detail_text_type") is not None else 'plain_text',
