...
from clio_mock.models.note_update_request_data_notification_event_subscribers_inner import NoteUpdateRequestDataNotificationEventSubscribersInner
try:
...
class NoteUpdateRequestData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["date", "detail", "detail_text_type", "notification_event_subscribers", "subject"]
