...
from clio_mock.models.email_address import EmailAddress
try:
...
class EmailAddressList(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [EmailAddress.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
