...
from clio_mock.models.notification_event_subscriber_base import NotificationEventSubscriberBase
...
class Note(BaseModel):
    ...
    detail: Optional[StrictStr] = Field(default=None, description="The text body of the *Note*. This Note supports rich text when setting the field `detail_text_type` to `rich_text`. With supported tags such as `<a>`, `<b>`, `<br>`, `<div>`, `<em>`, `<i>` `<li>`, `<ol>`, `<p>`, `<s>`, `<strong>`, `<u>` and `<ul>`. This Note also supports attributes such as `href`, `rel`, `type`, and `target`.")
    detail_text_type: Optional[StrictStr] = Field(default=None, description="The text type of the *Note*")
    ...
    __properties: ClassVar[List[str]] = ["id", "etag", "type", "subject", "detail", "detail_text_type", "date", "created_at", "updated_at", "time_entries_count", "matter", "contact", "author", "time_entries", "notification_event_subscribers"]
    ...
    @field_validator('detail_text_type')
    def detail_text_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "detail_text_type": obj.get("detail_text_type"),
            "date": obj.get("date"),
