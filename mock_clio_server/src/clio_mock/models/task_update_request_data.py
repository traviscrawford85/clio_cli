...
from clio_mock.models.task_update_request_data_assignee import TaskUpdateRequestDataAssignee
try:
...
class TaskUpdateRequestData(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Longer description of the Task. This Task supports rich text when the `description_text_type` field is set to `rich_text`. With supported tags such as `<a>`, `<b>`, `<br>`, `<div>`, `<em>`, `<i>` `<li>`, `<ol>`, `<p>`, `<s>`, `<strong>`, `<u>` and `<ul>`. This Task also supports attributes such as `href`, `rel`, `type`, and `target`.")
    ...
    __properties: ClassVar[List[str]] = ["assignee", "cascading", "cascading_offset", "cascading_offset_polarity", "cascading_offset_type", "cascading_source", "description", "description_text_type", "due_at", "matter", "name", "notify_assignee", "notify_completion", "permission", "priority", "status", "task_type", "time_estimated"]
