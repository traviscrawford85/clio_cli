...
from clio_mock.models.clio_creator_base import ClioCreatorBase
from clio_mock.models.contact_base import ContactBase
from clio_mock.models.document_category_base import DocumentCategoryBase
from clio_mock.models.document_version import DocumentVersion
from clio_mock.models.external_property_base import ExternalPropertyBase
from clio_mock.models.group_base import GroupBase
from clio_mock.models.linked_folder_base import LinkedFolderBase
...
class Document(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "etag", "created_at", "updated_at", "deleted_at", "type", "locked", "name", "received_at", "filename", "size", "content_type", "parent", "matter", "contact", "document_category", "creator", "latest_document_version", "group", "external_properties"]
