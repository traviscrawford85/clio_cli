...
from clio_mock.apis.document_templates_api_base import BaseDocumentTemplatesApi
...
from clio_mock.models.document_template_create_request import DocumentTemplateCreateRequest
from clio_mock.models.document_template_update_request import DocumentTemplateUpdateRequest
...
async def document_template_create(
    ...
    return await BaseDocumentTemplatesApi.subclasses[0]().document_template_create(x_api_versio_nheader, fieldsquery, document_template_create_request)
...
async def document_template_destroy(
    ...
    if not BaseDocumentTemplatesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentTemplatesApi.subclasses[0]().document_template_destroy(idpath, x_api_versio_nheader)
...
async def document_template_download(
    ...
    if not BaseDocumentTemplatesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentTemplatesApi.subclasses[0]().document_template_download(idpath)
...
async def document_template_index(
    ...
    if not BaseDocumentTemplatesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentTemplatesApi.subclasses[0]().document_template_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, orderquery, page_tokenquery, updated_sincequery)
...
async def document_template_show(
    ...
    if not BaseDocumentTemplatesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentTemplatesApi.subclasses[0]().document_template_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def document_template_update(
    ...
    if not BaseDocumentTemplatesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentTemplatesApi.subclasses[0]().document_template_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, document_template_update_request)
