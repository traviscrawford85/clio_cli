...
from clio_mock.apis.activity_rates_api_base import BaseActivityRatesApi
...
from clio_mock.models.activity_rate_create_request import ActivityRateCreateRequest
...
async def activity_rate_create(
    ...
    return await BaseActivityRatesApi.subclasses[0]().activity_rate_create(x_api_versio_nheader, fieldsquery, activity_rate_create_request)
...
async def activity_rate_destroy(
    ...
    if not BaseActivityRatesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActivityRatesApi.subclasses[0]().activity_rate_destroy(idpath, x_api_versio_nheader)
...
async def activity_rate_index(
    x_api_versio_nheader: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = Header(None, description="The [API minor version](#section/Minor-Versions). Default: latest version."),
    co_counsel_contact_idquery: Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. The keyword `null` is not valid for this field. The list will be filtered to include only the ActivityRate records with the matching property.")] = Query(None, description="The unique identifier for a single Contact. The keyword &#x60;null&#x60; is not valid for this field. The list will be filtered to include only the ActivityRate records with the matching property.", alias="co_counsel_contact_idquery"),
    ...
    if not BaseActivityRatesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActivityRatesApi.subclasses[0]().activity_rate_index(x_api_versio_nheader, co_counsel_contact_idquery, contact_idquery, created_sincequery, fieldsquery, idsquery, limitquery, page_tokenquery, updated_sincequery)
...
async def activity_rate_show(
    ...
    if not BaseActivityRatesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActivityRatesApi.subclasses[0]().activity_rate_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def activity_rate_update(
    ...
    if not BaseActivityRatesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActivityRatesApi.subclasses[0]().activity_rate_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, activity_rate_create_request)
