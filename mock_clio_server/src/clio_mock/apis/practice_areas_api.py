...
from clio_mock.apis.practice_areas_api_base import BasePracticeAreasApi
...
async def practice_area_create(
    ...
    return await BasePracticeAreasApi.subclasses[0]().practice_area_create(x_api_versio_nheader, fieldsquery, practice_area_create_request)
...
async def practice_area_destroy(
    ...
    if not BasePracticeAreasApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePracticeAreasApi.subclasses[0]().practice_area_destroy(idpath, x_api_versio_nheader)
...
async def practice_area_index(
    x_api_versio_nheader: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = Header(None, description="The [API minor version](#section/Minor-Versions). Default: latest version."),
    codequery: Annotated[Optional[StrictStr], Field(description="Filter PracticeArea records to those that match the given code.")] = Query(None, description="Filter PracticeArea records to those that match the given code.", alias="codequery"),
    ...
    if not BasePracticeAreasApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePracticeAreasApi.subclasses[0]().practice_area_index(x_api_versio_nheader, codequery, created_sincequery, fieldsquery, idsquery, limitquery, matter_idquery, namequery, orderquery, page_tokenquery, updated_sincequery)
...
async def practice_area_show(
    ...
    if not BasePracticeAreasApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePracticeAreasApi.subclasses[0]().practice_area_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def practice_area_update(
    ...
    if not BasePracticeAreasApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePracticeAreasApi.subclasses[0]().practice_area_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, practice_area_update_request)
