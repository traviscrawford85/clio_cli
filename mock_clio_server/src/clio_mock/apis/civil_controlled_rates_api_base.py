...
class BaseCivilControlledRatesApi:
    ...
    async def lauk_civil_controlled_rate_index(
        ...
        matter_type_1query: Annotated[Optional[StrictInt], Field(description="Filter by matter type 1.")],
        matter_type_2query: Annotated[Optional[StrictInt], Field(description="Filter by matter type 2.")],
