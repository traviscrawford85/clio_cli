...
from clio_mock.apis.matter_stages_api_base import BaseMatterStagesApi
...
async def matter_stage_index(
    ...
    return await BaseMatterStagesApi.subclasses[0]().matter_stage_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, page_tokenquery, practice_area_idquery, updated_sincequery)
