...
class BaseUsersApi:
    ...
    async def user_index(
        ...
        enabledquery: Annotated[Optional[StrictBool], Field(description="Filter TaskType records to those that are enabled or disabled.")],
        ...
        include_co_counselquery: Annotated[Optional[StrictBool], Field(description="Filter User to include co-counsel users")],
        ...
        pending_setupquery: Annotated[Optional[StrictBool], Field(description="Filter User records based on whether or not they are still being setup.")],
        rolequery: Annotated[Optional[StrictStr], Field(description="Filter User records to those with a specific role.")],
        subscription_typequery: Annotated[Optional[StrictStr], Field(description="Filter User records to those with a specific subscription type.")],
