...
from clio_mock.models.practice_area_create_request import PracticeAreaCreateRequest
from clio_mock.models.practice_area_update_request import PracticeAreaUpdateRequest
...
class BasePracticeAreasApi:
    ...
    async def practice_area_index(
        self,
        x_api_versio_nheader: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")],
        codequery: Annotated[Optional[StrictStr], Field(description="Filter PracticeArea records to those that match the given code.")],
