...
from clio_mock.apis.comments_api_base import BaseCommentsApi
...
from clio_mock.models.comment_create_request import CommentCreateRequest
from clio_mock.models.comment_update_request import CommentUpdateRequest
...
async def comment_create(
    ...
    return await BaseCommentsApi.subclasses[0]().comment_create(x_api_versio_nheader, fieldsquery, comment_create_request)
...
async def comment_destroy(
    ...
    if not BaseCommentsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCommentsApi.subclasses[0]().comment_destroy(idpath, x_api_versio_nheader)
...
async def comment_index(
    ...
    fieldsquery: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = Query(None, description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).", alias="fieldsquery"),
    item_idquery: Annotated[Optional[StrictInt], Field(description="The ID of the Document or Folder this Comment belongs to")] = Query(None, description="The ID of the Document or Folder this Comment belongs to", alias="item_idquery"),
    ...
    if not BaseCommentsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCommentsApi.subclasses[0]().comment_index(x_api_versio_nheader, created_sincequery, fieldsquery, item_idquery, limitquery, page_tokenquery, updated_sincequery)
...
async def comment_show(
    ...
    if not BaseCommentsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCommentsApi.subclasses[0]().comment_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def comment_update(
    ...
    if not BaseCommentsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCommentsApi.subclasses[0]().comment_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, comment_update_request)
