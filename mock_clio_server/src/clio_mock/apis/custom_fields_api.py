...
from clio_mock.apis.custom_fields_api_base import BaseCustomFieldsApi
...
from clio_mock.models.custom_field_create_request import CustomFieldCreateRequest
from clio_mock.models.custom_field_update_request import CustomFieldUpdateRequest
...
async def custom_field_create(
    ...
    return await BaseCustomFieldsApi.subclasses[0]().custom_field_create(x_api_versio_nheader, fieldsquery, custom_field_create_request)
...
async def custom_field_destroy(
    ...
    if not BaseCustomFieldsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomFieldsApi.subclasses[0]().custom_field_destroy(idpath, x_api_versio_nheader)
...
async def custom_field_index(
    ...
    deletedquery: Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that have been deleted for future use.")] = Query(None, description="Filter CustomField records to those that have been deleted for future use.", alias="deletedquery"),
    field_typequery: Annotated[Optional[StrictStr], Field(description="Field type of this custom field")] = Query(None, description="Field type of this custom field", alias="field_typequery"),
    fieldsquery: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = Query(None, description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).", alias="fieldsquery"),
    ...
    parent_typequery: Annotated[Optional[StrictInt], Field(description="Filter Allocation records based on whether the parent is a CreditMemo or a Payment.")] = Query(None, description="Filter Allocation records based on whether the parent is a CreditMemo or a Payment.", alias="parent_typequery"),
    ...
    visible_and_requiredquery: Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that are visible and required.")] = Query(None, description="Filter CustomField records to those that are visible and required.", alias="visible_and_requiredquery"),
) -> ActivityList:
    """Outlines the parameters, optional and required, used when requesting the data for all CustomFields"""
    if not BaseCustomFieldsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomFieldsApi.subclasses[0]().custom_field_index(x_api_versio_nheader, created_sincequery, deletedquery, field_typequery, fieldsquery, idsquery, limitquery, orderquery, page_tokenquery, parent_typequery, queryquery, updated_sincequery, visible_and_requiredquery)
...
async def custom_field_show(
    ...
    if not BaseCustomFieldsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomFieldsApi.subclasses[0]().custom_field_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def custom_field_update(
    ...
    if not BaseCustomFieldsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomFieldsApi.subclasses[0]().custom_field_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, custom_field_update_request)
