...
from clio_mock.apis.task_types_api_base import BaseTaskTypesApi
...
async def task_type_create(
    ...
    return await BaseTaskTypesApi.subclasses[0]().task_type_create(x_api_versio_nheader, fieldsquery, task_type_create_request)
...
async def task_type_index(
    ...
    if not BaseTaskTypesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTaskTypesApi.subclasses[0]().task_type_index(x_api_versio_nheader, created_sincequery, enabledquery, fieldsquery, idsquery, limitquery, namequery, orderquery, page_tokenquery, queryquery, updated_sincequery)
...
async def task_type_show(
    ...
    if not BaseTaskTypesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTaskTypesApi.subclasses[0]().task_type_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def task_type_update(
    ...
    if not BaseTaskTypesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTaskTypesApi.subclasses[0]().task_type_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, task_type_update_request)
