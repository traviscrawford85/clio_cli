...
class BaseCustomFieldsApi:
    ...
    async def custom_field_index(
        ...
        deletedquery: Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that have been deleted for future use.")],
        field_typequery: Annotated[Optional[StrictStr], Field(description="Field type of this custom field")],
        fieldsquery: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")],
        ...
        visible_and_requiredquery: Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that are visible and required.")],
    ) -> ActivityList:
