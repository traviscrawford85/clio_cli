...
from clio_mock.apis.email_addresses_api_base import BaseEmailAddressesApi
...
async def email_address_index(
    contact_idpath: Annotated[StrictInt, Field(description="ID of the Contact")] = Path(..., description="ID of the Contact"),
    ...
    return await BaseEmailAddressesApi.subclasses[0]().email_address_index(contact_idpath, x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, page_tokenquery, updated_sincequery)
