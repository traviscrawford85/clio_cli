...
from clio_mock.apis.damages_api_base import BaseDamagesApi
...
from clio_mock.models.damage_create_request import DamageCreateRequest
from clio_mock.models.damage_update_request import DamageUpdateRequest
...
async def damage_create(
    ...
    return await BaseDamagesApi.subclasses[0]().damage_create(x_api_versio_nheader, fieldsquery, damage_create_request)
...
async def damage_destroy(
    ...
    if not BaseDamagesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDamagesApi.subclasses[0]().damage_destroy(idpath, x_api_versio_nheader)
...
async def damage_index(
    ...
    if not BaseDamagesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDamagesApi.subclasses[0]().damage_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, page_tokenquery, updated_sincequery)
...
async def damage_show(
    ...
    if not BaseDamagesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDamagesApi.subclasses[0]().damage_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def damage_update(
    ...
    if not BaseDamagesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDamagesApi.subclasses[0]().damage_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, damage_update_request)
