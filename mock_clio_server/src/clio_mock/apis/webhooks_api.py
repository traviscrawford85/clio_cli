...
from clio_mock.apis.webhooks_api_base import BaseWebhooksApi
...
from clio_mock.models.webhook_create_request import WebhookCreateRequest
from clio_mock.models.webhook_update_request import WebhookUpdateRequest
...
async def webhook_create(
    ...
    return await BaseWebhooksApi.subclasses[0]().webhook_create(x_api_versio_nheader, fieldsquery, webhook_create_request)
...
async def webhook_destroy(
    ...
    if not BaseWebhooksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWebhooksApi.subclasses[0]().webhook_destroy(idpath, x_api_versio_nheader)
...
async def webhook_index(
    ...
    if not BaseWebhooksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWebhooksApi.subclasses[0]().webhook_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, orderquery, page_tokenquery, updated_sincequery)
...
async def webhook_show(
    ...
    if not BaseWebhooksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWebhooksApi.subclasses[0]().webhook_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def webhook_update(
    ...
    if not BaseWebhooksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWebhooksApi.subclasses[0]().webhook_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, webhook_update_request)
