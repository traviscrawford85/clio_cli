...
from clio_mock.apis.grants_api_base import BaseGrantsApi
...
from clio_mock.models.grant_create_request import GrantCreateRequest
...
async def grant_create(
    ...
    return await BaseGrantsApi.subclasses[0]().grant_create(x_api_versio_nheader, fieldsquery, grant_create_request)
...
async def grant_destroy(
    ...
    if not BaseGrantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGrantsApi.subclasses[0]().grant_destroy(idpath, x_api_versio_nheader)
...
async def grant_index(
    ...
    if not BaseGrantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGrantsApi.subclasses[0]().grant_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, namequery, page_tokenquery, updated_sincequery)
...
async def grant_show(
    ...
    if not BaseGrantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGrantsApi.subclasses[0]().grant_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def grant_update(
    ...
    if not BaseGrantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGrantsApi.subclasses[0]().grant_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, grant_create_request)
