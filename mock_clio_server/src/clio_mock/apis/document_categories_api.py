...
from clio_mock.apis.document_categories_api_base import BaseDocumentCategoriesApi
...
from clio_mock.models.document_category_create_request import DocumentCategoryCreateRequest
from clio_mock.models.document_category_update_request import DocumentCategoryUpdateRequest
...
async def document_category_create(
    ...
    return await BaseDocumentCategoriesApi.subclasses[0]().document_category_create(x_api_versio_nheader, fieldsquery, document_category_create_request)
...
async def document_category_destroy(
    ...
    if not BaseDocumentCategoriesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentCategoriesApi.subclasses[0]().document_category_destroy(idpath, x_api_versio_nheader)
...
async def document_category_index(
    ...
    if not BaseDocumentCategoriesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentCategoriesApi.subclasses[0]().document_category_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, orderquery, page_tokenquery, queryquery, updated_sincequery)
...
async def document_category_show(
    ...
    if not BaseDocumentCategoriesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentCategoriesApi.subclasses[0]().document_category_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def document_category_update(
    ...
    if not BaseDocumentCategoriesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentCategoriesApi.subclasses[0]().document_category_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, document_category_update_request)
