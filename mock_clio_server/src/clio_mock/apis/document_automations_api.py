...
from clio_mock.apis.document_automations_api_base import BaseDocumentAutomationsApi
...
from clio_mock.models.document_automation_create_request import DocumentAutomationCreateRequest
...
async def document_automation_create(
    ...
    return await BaseDocumentAutomationsApi.subclasses[0]().document_automation_create(x_api_versio_nheader, fieldsquery, document_automation_create_request)
...
async def document_automation_index(
    ...
    if not BaseDocumentAutomationsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentAutomationsApi.subclasses[0]().document_automation_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, orderquery, page_tokenquery, updated_sincequery)
...
async def document_automation_show(
    ...
    if not BaseDocumentAutomationsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDocumentAutomationsApi.subclasses[0]().document_automation_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
