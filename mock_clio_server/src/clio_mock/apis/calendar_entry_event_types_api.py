...
from clio_mock.apis.calendar_entry_event_types_api_base import BaseCalendarEntryEventTypesApi
...
from clio_mock.models.calendar_entry_event_type_create_request import CalendarEntryEventTypeCreateRequest
from clio_mock.models.calendar_entry_event_type_update_request import CalendarEntryEventTypeUpdateRequest
...
async def calendar_entry_event_type_create(
    ...
    return await BaseCalendarEntryEventTypesApi.subclasses[0]().calendar_entry_event_type_create(x_api_versio_nheader, fieldsquery, calendar_entry_event_type_create_request)
...
async def calendar_entry_event_type_destroy(
    ...
    if not BaseCalendarEntryEventTypesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCalendarEntryEventTypesApi.subclasses[0]().calendar_entry_event_type_destroy(idpath, x_api_versio_nheader)
...
async def calendar_entry_event_type_index(
    ...
    if not BaseCalendarEntryEventTypesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCalendarEntryEventTypesApi.subclasses[0]().calendar_entry_event_type_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, page_tokenquery, updated_sincequery)
...
async def calendar_entry_event_type_show(
    ...
    if not BaseCalendarEntryEventTypesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCalendarEntryEventTypesApi.subclasses[0]().calendar_entry_event_type_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def calendar_entry_event_type_update(
    ...
    if not BaseCalendarEntryEventTypesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCalendarEntryEventTypesApi.subclasses[0]().calendar_entry_event_type_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, calendar_entry_event_type_update_request)
