...
from clio_mock.apis.bank_transactions_api_base import BaseBankTransactionsApi
...
async def bank_transaction_index(
    ...
    return await BaseBankTransactionsApi.subclasses[0]().bank_transaction_index(x_api_versio_nheader, bank_account_idquery, client_idquery, created_sincequery, fieldsquery, idsquery, limitquery, matter_idquery, orderquery, page_tokenquery, typequery, updated_sincequery)
...
async def bank_transaction_show(
    ...
    if not BaseBankTransactionsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBankTransactionsApi.subclasses[0]().bank_transaction_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
