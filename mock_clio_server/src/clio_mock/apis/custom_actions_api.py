...
from clio_mock.apis.custom_actions_api_base import BaseCustomActionsApi
...
from clio_mock.models.custom_action_create_request import CustomActionCreateRequest
from clio_mock.models.custom_action_update_request import CustomActionUpdateRequest
...
async def custom_action_create(
    ...
    return await BaseCustomActionsApi.subclasses[0]().custom_action_create(x_api_versio_nheader, fieldsquery, custom_action_create_request)
...
async def custom_action_destroy(
    ...
    if not BaseCustomActionsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomActionsApi.subclasses[0]().custom_action_destroy(idpath, x_api_versio_nheader)
...
async def custom_action_index(
    ...
    if not BaseCustomActionsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomActionsApi.subclasses[0]().custom_action_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, page_tokenquery, updated_sincequery)
...
async def custom_action_show(
    ...
    if not BaseCustomActionsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomActionsApi.subclasses[0]().custom_action_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def custom_action_update(
    ...
    if not BaseCustomActionsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomActionsApi.subclasses[0]().custom_action_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, custom_action_update_request)
