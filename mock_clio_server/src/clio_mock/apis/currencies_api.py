...
from clio_mock.apis.currencies_api_base import BaseCurrenciesApi
...
async def currency_index(
    ...
    return await BaseCurrenciesApi.subclasses[0]().currency_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, page_tokenquery, updated_sincequery)
