...
from clio_mock.apis.expense_categories_api_base import BaseExpenseCategoriesApi
...
async def expense_category_create(
    ...
    return await BaseExpenseCategoriesApi.subclasses[0]().expense_category_create(x_api_versio_nheader, fieldsquery, expense_category_create_request)
...
async def expense_category_destroy(
    ...
    if not BaseExpenseCategoriesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseExpenseCategoriesApi.subclasses[0]().expense_category_destroy(idpath, x_api_versio_nheader)
...
async def expense_category_index(
    ...
    entry_typequery: Annotated[Optional[StrictStr], Field(description="Filter ExpenseCategory records to those that match the given type.")] = Query(None, description="Filter ExpenseCategory records to those that match the given type.", alias="entry_typequery"),
    fieldsquery: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = Query(None, description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).", alias="fieldsquery"),
    ...
    if not BaseExpenseCategoriesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseExpenseCategoriesApi.subclasses[0]().expense_category_index(x_api_versio_nheader, created_sincequery, entry_typequery, fieldsquery, limitquery, orderquery, page_tokenquery, queryquery, updated_sincequery)
...
async def expense_category_show(
    ...
    if not BaseExpenseCategoriesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseExpenseCategoriesApi.subclasses[0]().expense_category_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def expense_category_update(
    ...
    if not BaseExpenseCategoriesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseExpenseCategoriesApi.subclasses[0]().expense_category_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, expense_category_update_request)
...
async def lauk_expense_category_index(
    ...
    page_tokenquery: Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = Query(None, description="A token specifying which page to return.", alias="page_tokenquery"),
    practice_areaquery: Annotated[Optional[StrictStr], Field(description="Filter by expense practice area.")] = Query(None, description="Filter by expense practice area.", alias="practice_areaquery"),
    ...
    if not BaseExpenseCategoriesApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseExpenseCategoriesApi.subclasses[0]().lauk_expense_category_index(x_api_versio_nheader, fieldsquery, keyquery, limitquery, namequery, page_tokenquery, practice_areaquery, regionquery)
