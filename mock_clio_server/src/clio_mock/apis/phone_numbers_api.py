...
from clio_mock.apis.phone_numbers_api_base import BasePhoneNumbersApi
...
async def phone_number_index(
    ...
    return await BasePhoneNumbersApi.subclasses[0]().phone_number_index(contact_idpath, x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, page_tokenquery, updated_sincequery)
