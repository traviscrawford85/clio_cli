...
class BaseConversationsApi:
    ...
    async def conversation_index(
        ...
        for_userquery: Annotated[Optional[StrictBool], Field(description="If set to true, filter Conversation records accessible to any groups of the user. Note that the user may not be member of the conversations.  If set to false, filter Conversation records of which the user is a member. ")],
        ...
        read_statusquery: Annotated[Optional[StrictBool], Field(description="Filter Conversation records to those which have been read.")],
        time_entriesquery: Annotated[Optional[StrictBool], Field(description="Filter Conversation records to those with or without associated time entries.")],
