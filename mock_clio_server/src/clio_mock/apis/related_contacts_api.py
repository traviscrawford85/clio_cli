...
from clio_mock.apis.related_contacts_api_base import BaseRelatedContactsApi
...
async def related_contacts_index(
    ...
    return await BaseRelatedContactsApi.subclasses[0]().related_contacts_index(matter_idpath, x_api_versio_nheader, fieldsquery, limitquery, orderquery, page_tokenquery)
