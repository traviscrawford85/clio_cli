...
from clio_mock.apis.clio_payments_links_api_base import BaseClioPaymentsLinksApi
...
from clio_mock.models.clio_payments_link_create_request import ClioPaymentsLinkCreateRequest
from clio_mock.models.clio_payments_link_update_request import ClioPaymentsLinkUpdateRequest
...
async def clio_payments_link_create(
    ...
    return await BaseClioPaymentsLinksApi.subclasses[0]().clio_payments_link_create(x_api_versio_nheader, fieldsquery, clio_payments_link_create_request)
...
async def clio_payments_link_index(
    x_api_versio_nheader: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = Header(None, description="The [API minor version](#section/Minor-Versions). Default: latest version."),
    activequery: Annotated[Optional[StrictBool], Field(description="Filter ClioPaymentsLink records based on whether or not they have expired.")] = Query(None, description="Filter ClioPaymentsLink records based on whether or not they have expired.", alias="activequery"),
    ...
    if not BaseClioPaymentsLinksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseClioPaymentsLinksApi.subclasses[0]().clio_payments_link_index(x_api_versio_nheader, activequery, created_sincequery, fieldsquery, idsquery, limitquery, page_tokenquery, updated_sincequery)
...
async def clio_payments_link_show(
    ...
    if not BaseClioPaymentsLinksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseClioPaymentsLinksApi.subclasses[0]().clio_payments_link_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def clio_payments_link_update(
    ...
    if not BaseClioPaymentsLinksApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseClioPaymentsLinksApi.subclasses[0]().clio_payments_link_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, clio_payments_link_update_request)
