...
from clio_mock.apis.utbms_sets_api_base import BaseUtbmsSetsApi
...
async def utbms_set_index(
    ...
    return await BaseUtbmsSetsApi.subclasses[0]().utbms_set_index(x_api_versio_nheader, created_sincequery, fieldsquery, idsquery, limitquery, orderquery, page_tokenquery, updated_sincequery)
