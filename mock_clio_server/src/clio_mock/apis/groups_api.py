...
from clio_mock.apis.groups_api_base import BaseGroupsApi
...
from clio_mock.models.group_create_request import GroupCreateRequest
...
async def group_create(
    ...
    return await BaseGroupsApi.subclasses[0]().group_create(x_api_versio_nheader, fieldsquery, group_create_request)
...
async def group_destroy(
    ...
    if not BaseGroupsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGroupsApi.subclasses[0]().group_destroy(idpath, x_api_versio_nheader)
...
async def group_index(
    ...
    if not BaseGroupsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGroupsApi.subclasses[0]().group_index(x_api_versio_nheader, archivedquery, created_sincequery, fieldsquery, idsquery, limitquery, namequery, orderquery, page_tokenquery, queryquery, typequery, updated_sincequery, user_idquery)
...
async def group_show(
    ...
    if not BaseGroupsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGroupsApi.subclasses[0]().group_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def group_update(
    ...
    if not BaseGroupsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGroupsApi.subclasses[0]().group_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, group_create_request)
