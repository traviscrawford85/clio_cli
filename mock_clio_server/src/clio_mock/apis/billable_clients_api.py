...
from clio_mock.apis.billable_clients_api_base import BaseBillableClientsApi
...
async def billable_client_index(
    ...
    return await BaseBillableClientsApi.subclasses[0]().billable_client_index(x_api_versio_nheader, client_idquery, custom_field_valuesquery, end_datequery, fieldsquery, limitquery, matter_idquery, originating_attorney_idquery, page_tokenquery, queryquery, responsible_attorney_idquery, start_datequery)
