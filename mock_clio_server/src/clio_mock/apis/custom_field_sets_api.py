...
from clio_mock.apis.custom_field_sets_api_base import BaseCustomFieldSetsApi
...
async def custom_field_set_create(
    ...
    return await BaseCustomFieldSetsApi.subclasses[0]().custom_field_set_create(x_api_versio_nheader, fieldsquery, custom_field_set_create_request)
...
async def custom_field_set_destroy(
    ...
    if not BaseCustomFieldSetsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomFieldSetsApi.subclasses[0]().custom_field_set_destroy(idpath, x_api_versio_nheader)
...
async def custom_field_set_index(
    ...
    displayedquery: Annotated[Optional[StrictBool], Field(description="Filter CustomFieldSet records to those that should be displayed by default.")] = Query(None, description="Filter CustomFieldSet records to those that should be displayed by default.", alias="displayedquery"),
    fieldsquery: Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = Query(None, description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).", alias="fieldsquery"),
    ...
    if not BaseCustomFieldSetsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomFieldSetsApi.subclasses[0]().custom_field_set_index(x_api_versio_nheader, created_sincequery, displayedquery, fieldsquery, idsquery, limitquery, orderquery, page_tokenquery, parent_typequery, queryquery, updated_sincequery)
...
async def custom_field_set_show(
    ...
    if not BaseCustomFieldSetsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomFieldSetsApi.subclasses[0]().custom_field_set_show(idpath, if_modified_sinc_eheader, if_none_matc_hheader, x_api_versio_nheader, fieldsquery)
...
async def custom_field_set_update(
    ...
    if not BaseCustomFieldSetsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomFieldSetsApi.subclasses[0]().custom_field_set_update(idpath, if_matc_hheader, x_api_versio_nheader, fieldsquery, custom_field_set_update_request)
