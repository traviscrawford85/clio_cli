...
def test_jurisdiction_index(client: TestClient):
    ...
    """
    params = [("created_sincequery", '2013-10-20T19:20:30+01:00'),     ("fieldsquery", 'fieldsquery_example'),     ("for_current_accountquery", True),     ("idsquery", 56),     ("limitquery", 56),     ("orderquery", 'orderquery_example'),     ("page_tokenquery", 'page_tokenquery_example'),     ("queryquery", 'queryquery_example'),     ("updated_sincequery", '2013-10-20T19:20:30+01:00')]
    headers = {
...
def test_jurisdiction_show(client: TestClient):
    ...
    #response = client.request(
    #    "GET",
    #    "/court_rules/jurisdictions/{id}.json".format(idpath=56),
    #    headers=headers,
    #    params=params,
    #)
