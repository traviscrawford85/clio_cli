...
def test_related_contacts_index(client: TestClient):
    ...
    """
    params = [("fieldsquery", 'fieldsquery_example'),     ("limitquery", 56),     ("orderquery", 'orderquery_example'),     ("page_tokenquery", 'page_tokenquery_example')]
    headers = {
    ...
    #    "GET",
    #    "/matters/{matter_id}/related_contacts.json".format(matter_idpath=56),
    #    headers=headers,
    #    params=params,
    #)
