...
from clio_mock.models.task_template_create_request import TaskTemplateCreateRequest  # noqa: F401
from clio_mock.models.task_template_update_request import TaskTemplateUpdateRequest  # noqa: F401
...
def test_task_template_create(client: TestClient):
    ...
    """
    task_template_create_request = clio_mock.TaskTemplateCreateRequest()
...
def test_task_template_destroy(client: TestClient):
    ...
    #response = client.request(
    #    "DELETE",
    #    "/task_templates/{id}.json".format(idpath=56),
    #    headers=headers,
    #)
...
def test_task_template_index(client: TestClient):
    ...
    """
    params = [("created_sincequery", '2013-10-20T19:20:30+01:00'),     ("fieldsquery", 'fieldsquery_example'),     ("idsquery", 56),     ("limitquery", 56),     ("orderquery", 'orderquery_example'),     ("page_tokenquery", 'page_tokenquery_example'),     ("priorityquery", 'priorityquery_example'),     ("queryquery", 'queryquery_example'),     ("task_template_list_idquery", 56),     ("updated_sincequery", '2013-10-20T19:20:30+01:00')]
    headers = {
        "x_api_versio_nheader": 'x_api_versio_nheader_example',
    }
    # uncomment below to make a request
...
def test_task_template_update(client: TestClient):
    ...
    """
    task_template_update_request = clio_mock.TaskTemplateUpdateRequest()
    params = [("fieldsquery", 'fieldsquery_example')]
    headers = {
