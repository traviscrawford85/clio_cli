...
def test_allocation_index(client: TestClient):
    ...
    """
    params = [("bill_idquery", 56),     ("contact_idquery", 56),     ("created_sincequery", '2013-10-20T19:20:30+01:00'),     ("fieldsquery", 'fieldsquery_example'),     ("idsquery", 56),     ("limitquery", 56),     ("matter_idquery", 56),     ("orderquery", 'orderquery_example'),     ("page_tokenquery", 'page_tokenquery_example'),     ("parent_idquery", 56),     ("parent_typequery", 56),     ("statusquery", 'statusquery_example'),     ("updated_sincequery", '2013-10-20T19:20:30+01:00')]
    headers = {
...
def test_allocation_show(client: TestClient):
    ...
    #response = client.request(
    #    "GET",
    #    "/allocations/{id}.json".format(idpath=56),
    #    headers=headers,
    #    params=params,
    #)
