...
def test_clio_payments_payment_index(client: TestClient):
    ...
    """
    params = [("bill_idquery", 56),     ("contact_idquery", 56),     ("fieldsquery", 'fieldsquery_example'),     ("idsquery", 56),     ("limitquery", 56),     ("page_tokenquery", 'page_tokenquery_example'),     ("statequery", 'statequery_example')]
    headers = {
...
def test_clio_payments_payment_show(client: TestClient):
    ...
    #response = client.request(
    #    "GET",
    #    "/clio_payments/payments/{id}.json".format(idpath=56),
    #    headers=headers,
    #    params=params,
    #)
