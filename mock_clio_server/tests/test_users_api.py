...
def test_user_index(client: TestClient):
    ...
    """
    params = [("created_sincequery", '2013-10-20T19:20:30+01:00'),     ("enabledquery", True),     ("fieldsquery", 'fieldsquery_example'),     ("idsquery", 56),     ("include_co_counselquery", True),     ("limitquery", 56),     ("namequery", 'namequery_example'),     ("orderquery", 'orderquery_example'),     ("page_tokenquery", 'page_tokenquery_example'),     ("pending_setupquery", True),     ("rolequery", 'rolequery_example'),     ("subscription_typequery", 'subscription_typequery_example'),     ("updated_sincequery", '2013-10-20T19:20:30+01:00')]
    headers = {
...
def test_user_show(client: TestClient):
    ...
    #response = client.request(
    #    "GET",
    #    "/users/{id}.json".format(idpath=56),
    #    headers=headers,
    #    params=params,
    #)
