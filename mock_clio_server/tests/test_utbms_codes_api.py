...
def test_utbms_code_index(client: TestClient):
    ...
    """
    params = [("created_sincequery", '2013-10-20T19:20:30+01:00'),     ("fieldsquery", 'fieldsquery_example'),     ("idsquery", 56),     ("limitquery", 56),     ("orderquery", 'orderquery_example'),     ("page_tokenquery", 'page_tokenquery_example'),     ("typequery", 'typequery_example'),     ("updated_sincequery", '2013-10-20T19:20:30+01:00'),     ("utbms_set_idquery", 56)]
    headers = {
...
def test_utbms_code_show(client: TestClient):
    ...
    #response = client.request(
    #    "GET",
    #    "/utbms/codes/{id}.json".format(idpath=56),
    #    headers=headers,
    #    params=params,
    #)
