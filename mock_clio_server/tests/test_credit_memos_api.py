...
def test_credit_memo_index(client: TestClient):
    ...
    """
    params = [("contact_idquery", 56),     ("created_sincequery", '2013-10-20T19:20:30+01:00'),     ("fieldsquery", 'fieldsquery_example'),     ("idsquery", 56),     ("limitquery", 56),     ("orderquery", 'orderquery_example'),     ("page_tokenquery", 'page_tokenquery_example'),     ("updated_sincequery", '2013-10-20T19:20:30+01:00')]
    headers = {
...
def test_credit_memo_show(client: TestClient):
    ...
    #response = client.request(
    #    "GET",
    #    "/credit_memos/{id}.json".format(idpath=56),
    #    headers=headers,
    #    params=params,
    #)
