...
def test_bank_transaction_index(client: TestClient):
    ...
    """
    params = [("bank_account_idquery", 56),     ("client_idquery", 56),     ("created_sincequery", '2013-10-20T19:20:30+01:00'),     ("fieldsquery", 'fieldsquery_example'),     ("idsquery", 56),     ("limitquery", 56),     ("matter_idquery", 56),     ("orderquery", 'orderquery_example'),     ("page_tokenquery", 'page_tokenquery_example'),     ("typequery", 'typequery_example'),     ("updated_sincequery", '2013-10-20T19:20:30+01:00')]
    headers = {
...
def test_bank_transaction_show(client: TestClient):
    ...
    #response = client.request(
    #    "GET",
    #    "/bank_transactions/{id}.json".format(idpath=56),
    #    headers=headers,
    #    params=params,
    #)
