...
from clio_mock.models.webhook_create_request import WebhookCreateRequest  # noqa: F401
from clio_mock.models.webhook_update_request import WebhookUpdateRequest  # noqa: F401
...
def test_webhook_create(client: TestClient):
    ...
    """
    webhook_create_request = clio_mock.WebhookCreateRequest()
...
def test_webhook_destroy(client: TestClient):
    ...
    #response = client.request(
    #    "DELETE",
    #    "/webhooks/{id}.json".format(idpath=56),
    #    headers=headers,
    #)
...
def test_webhook_update(client: TestClient):
    ...
    """
    webhook_update_request = clio_mock.WebhookUpdateRequest()
    params = [("fieldsquery", 'fieldsquery_example')]
    headers = {
