...
from clio_mock.models.calendar_visibility_update_request import CalendarVisibilityUpdateRequest  # noqa: F401
...
def test_calendar_visibility_show(client: TestClient):
    ...
    #response = client.request(
    #    "GET",
    #    "/task_calendars/{id}.json".format(idpath=56),
    #    headers=headers,
    #    params=params,
    #)
...
def test_calendar_visibility_update(client: TestClient):
    ...
    """
    calendar_visibility_update_request = clio_mock.CalendarVisibilityUpdateRequest()
    params = [("fieldsquery", 'fieldsquery_example')]
    headers = {
