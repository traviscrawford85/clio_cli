...
from clio_mock.models.bill_theme_update_request import BillThemeUpdateRequest  # noqa: F401
...
def test_bill_theme_update(client: TestClient):
    ...
    """
    bill_theme_update_request = clio_mock.BillThemeUpdateRequest()
    ...
    #response = client.request(
    #    "PATCH",
    #    "/bill_themes/{id}.json".format(idpath=56),
    #    headers=headers,
