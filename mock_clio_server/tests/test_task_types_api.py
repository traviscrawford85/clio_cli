...
from clio_mock.models.task_type_create_request import TaskTypeCreateRequest  # noqa: F401
from clio_mock.models.task_type_update_request import TaskTypeUpdateRequest  # noqa: F401
...
def test_task_type_create(client: TestClient):
    ...
    """
    task_type_create_request = clio_mock.TaskTypeCreateRequest()
...
def test_task_type_index(client: TestClient):
    ...
    """
    params = [("created_sincequery", '2013-10-20T19:20:30+01:00'),     ("enabledquery", True),     ("fieldsquery", 'fieldsquery_example'),     ("idsquery", 56),     ("limitquery", 56),     ("namequery", 'namequery_example'),     ("orderquery", 'orderquery_example'),     ("page_tokenquery", 'page_tokenquery_example'),     ("queryquery", 'queryquery_example'),     ("updated_sincequery", '2013-10-20T19:20:30+01:00')]
    headers = {
        "x_api_versio_nheader": 'x_api_versio_nheader_example',
    }
    # uncomment below to make a request
...
def test_task_type_show(client: TestClient):
    ...
    #response = client.request(
    #    "GET",
    #    "/task_types/{id}.json".format(idpath=56),
    #    headers=headers,
    #    params=params,
    #)
...
def test_task_type_update(client: TestClient):
    ...
    """
    task_type_update_request = clio_mock.TaskTypeUpdateRequest()
    params = [("fieldsquery", 'fieldsquery_example')]
    headers = {
