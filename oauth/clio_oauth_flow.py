...
async def clio_home():
    ...
    # services/oauth/clio_oauth_flow.py
...
async def clio_callback(request: Request):
    ...
    def load_authenticated_clio_token(user_id: str = "default") -> dict:
    """Load and refresh Clio token if needed."""
    return load_token_data(user_id)
